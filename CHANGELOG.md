...
## [0.3.5](https://github.com/0xtaos/chmonitor/compare/v0.3.4...v0.3.5) (2026-09-19)


### ✨ Features

* add centered logo to README ([f74d754](https://github.com/0xtaos/chmonitor/commit/f74d754e21d8f2f4937938fae0406e3cb41bad12))
* **advisor:** auto fine-tune engine — schema + settings tuning suggestions ([#2771](https://github.com/0xtaos/chmonitor/issues/2771)) ([a3eb48f](https://github.com/0xtaos/chmonitor/commit/a3eb48fb0314b1ae5365b6f39ed1d453f4ee7a49))
* **advisor:** copyable local vs ON CLUSTER DDL variants ([#3151](https://github.com/0xtaos/chmonitor/issues/3151)) ([2a6339a](https://github.com/0xtaos/chmonitor/commit/2a6339acb84a299aea587743e521b7d511c36c54))
* **advisor:** default Schema tab with explorer tree ([#3267](https://github.com/0xtaos/chmonitor/issues/3267)) ([ed06ca2](https://github.com/0xtaos/chmonitor/commit/ed06ca27e625a4605709047961a4e471e357d13f))
* **advisor:** table-level schema advice, TTL inventory, and health check ([#3196](https://github.com/0xtaos/chmonitor/issues/3196)) ([de588fa](https://github.com/0xtaos/chmonitor/commit/de588fa36a118f8b7d4c32bae4d0f84103d8aa72))
* **agent:** add estimate_mutation_impact tool for DDL mutation impact dry-run ([#2773](https://github.com/0xtaos/chmonitor/issues/2773)) ([39126f3](https://github.com/0xtaos/chmonitor/commit/39126f30de901a792ce4242f53983ca3bfa21906))
* **agent:** allow cloud demo guests to chat ([#3055](https://github.com/0xtaos/chmonitor/issues/3055)) ([9c6859a](https://github.com/0xtaos/chmonitor/commit/9c6859acc086ed3c054988a8d3b759458bf1a1ec))
* **agent:** allowlist Firecrawl scrape domains ([#3181](https://github.com/0xtaos/chmonitor/issues/3181)) ([d574117](https://github.com/0xtaos/chmonitor/commit/d574117bd833a1c7e8d395aa579b79a48dcf8d37))
* **agent:** cap and track guest AI usage on Cloud ([#3023](https://github.com/0xtaos/chmonitor/issues/3023)) ([02773cc](https://github.com/0xtaos/chmonitor/commit/02773cc8f56ea6862fae4ecbd270e5951b319e4c))
* **agent:** collapse sidebars when starting from a suggestion ([#3273](https://github.com/0xtaos/chmonitor/issues/3273)) ([a4aa909](https://github.com/0xtaos/chmonitor/commit/a4aa909b6c030984804b454f270e143fec3faab5))
* **agent:** connect keyless Firecrawl MCP by default ([#3062](https://github.com/0xtaos/chmonitor/issues/3062)) ([1004573](https://github.com/0xtaos/chmonitor/commit/10045731f74bd0878e58b79a3e152903bbc4eb49))
* **agent:** conversation rail, ChartCard visualization, unified surfaces ([#2811](https://github.com/0xtaos/chmonitor/issues/2811)) ([#2822](https://github.com/0xtaos/chmonitor/issues/2822)) ([da67092](https://github.com/0xtaos/chmonitor/commit/da670925576eecb36fb22e9bb63e6b2cbbf927b0))
* **agent:** dynamic model listing, AnyRouter presets and sign-in, custom model input ([#2982](https://github.com/0xtaos/chmonitor/issues/2982)) ([5d1b482](https://github.com/0xtaos/chmonitor/commit/5d1b48226d0fb679942338223bf47bef768f84b2))
* **agent:** polish chat messages, tools, and markdown ([#3058](https://github.com/0xtaos/chmonitor/issues/3058)) ([8415eac](https://github.com/0xtaos/chmonitor/commit/8415eacaa9f22d12a1f9af7b3a2c6b3c68d75367))
* **agent:** rank AnyRouter models by usage for auto pick ([#2856](https://github.com/0xtaos/chmonitor/issues/2856)) ([75bf15d](https://github.com/0xtaos/chmonitor/commit/75bf15dd7d3aa01d550ee851cc14501647105968))
* **agent:** redesign agent page — welcome, composer, thread polish, token colors ([#2811](https://github.com/0xtaos/chmonitor/issues/2811)) ([#2819](https://github.com/0xtaos/chmonitor/issues/2819)) ([57acfec](https://github.com/0xtaos/chmonitor/commit/57acfecf33e29a2cba0177a2f84fbf1779bdedc0))
* **agents:** make follow-up suggestions tool-aware and anchor them to the composer ([#3040](https://github.com/0xtaos/chmonitor/issues/3040)) ([301bf22](https://github.com/0xtaos/chmonitor/commit/301bf22ab42767af170b4079ee2fa370a5f7c5e8))
* **alerts:** deliver alert.fired/alert.resolved to instance-scoped webhook subscriptions ([#2737](https://github.com/0xtaos/chmonitor/issues/2737)) ([6e6df3b](https://github.com/0xtaos/chmonitor/commit/6e6df3b33f0a4980e94bbf9bf3c31512a7f1d359))
* **alerts:** Google Chat delivery channel ([#2660](https://github.com/0xtaos/chmonitor/issues/2660)) ([#2723](https://github.com/0xtaos/chmonitor/issues/2723)) ([bfc34ae](https://github.com/0xtaos/chmonitor/commit/bfc34ae0f5c8e866c38450d92cc14956a08e23aa))
* **alerts:** hysteresis + transition-based delivery (anti-flap) ([#2775](https://github.com/0xtaos/chmonitor/issues/2775)) ([3843ca8](https://github.com/0xtaos/chmonitor/commit/3843ca8c69f8482c7476a1614a1926f85528435a))
* **alerts:** Microsoft Teams delivery channel ([#2688](https://github.com/0xtaos/chmonitor/issues/2688)) ([960b49a](https://github.com/0xtaos/chmonitor/commit/960b49a3ee2947ebdc26534659a5ffb7878a3ce0)), closes [#2658](https://github.com/0xtaos/chmonitor/issues/2658)
* **alerts:** ntfy delivery channel ([#2681](https://github.com/0xtaos/chmonitor/issues/2681)) ([c3e9108](https://github.com/0xtaos/chmonitor/commit/c3e9108d8b81cc521b7e7a1ef8d3a7b7ec89a97a)), closes [#2657](https://github.com/0xtaos/chmonitor/issues/2657)
* **alerts:** per-URL adapter bodies in webhook dispatch ([#2671](https://github.com/0xtaos/chmonitor/issues/2671)) ([7557357](https://github.com/0xtaos/chmonitor/commit/7557357a446f6ae3b2072f54be64a6cb1eb57124)), closes [#2656](https://github.com/0xtaos/chmonitor/issues/2656)
* **alerts:** Pushover delivery channel ([#2659](https://github.com/0xtaos/chmonitor/issues/2659)) ([#2735](https://github.com/0xtaos/chmonitor/issues/2735)) ([bdbcbe7](https://github.com/0xtaos/chmonitor/commit/bdbcbe7f1344f4382dca857748ae4cdd87b03f51))
* **alerts:** quiet hours — recurring time-of-day silence windows ([#2700](https://github.com/0xtaos/chmonitor/issues/2700)) ([c35d89e](https://github.com/0xtaos/chmonitor/commit/c35d89eadb94104c5b2b0dbe363401e9fd99dfb5))
* **alerts:** redesign alert-settings channels as a configured-first card grid ([#2881](https://github.com/0xtaos/chmonitor/issues/2881)) ([382a02a](https://github.com/0xtaos/chmonitor/commit/382a02acc120ff0ff6512feaea48bca1296ee709))
* **alerts:** simplify alert settings with templates and presets ([#3030](https://github.com/0xtaos/chmonitor/issues/3030)) ([da6ffd2](https://github.com/0xtaos/chmonitor/commit/da6ffd283db4be1e9be3dde4edd9a9d6e39b8e8a))
* **alerts:** smart auto-suggest alert rules from live cluster behavior ([#2674](https://github.com/0xtaos/chmonitor/issues/2674)) ([885418c](https://github.com/0xtaos/chmonitor/commit/885418c2f73e5b16ac38f8276cbf55371d62000e)), closes [#2667](https://github.com/0xtaos/chmonitor/issues/2667)
* **alerts:** Twilio SMS delivery channel ([#2668](https://github.com/0xtaos/chmonitor/issues/2668)) ([#2734](https://github.com/0xtaos/chmonitor/issues/2734)) ([aa6d7cd](https://github.com/0xtaos/chmonitor/commit/aa6d7cd04328079422c28975cf71b8404e11ebbf))
* **alerts:** wire the Telegram alert channel end-to-end ([#2670](https://github.com/0xtaos/chmonitor/issues/2670)) ([cac53ab](https://github.com/0xtaos/chmonitor/commit/cac53ab8035163d90809a68ce1d41dbea1bd7063)), closes [#2655](https://github.com/0xtaos/chmonitor/issues/2655)
* **auth:** add local basic auth provider ([a04a3aa](https://github.com/0xtaos/chmonitor/commit/a04a3aa170316a503635932d31f5fbecc7fa4bdd))
* **billing:** $199 Fleet mid-anchor tier behind experiment flag ([#2381](https://github.com/0xtaos/chmonitor/issues/2381)) ([#2637](https://github.com/0xtaos/chmonitor/issues/2637)) ([ac5dcd0](https://github.com/0xtaos/chmonitor/commit/ac5dcd05af17d56cb813180e087365562c0c0999))
* **billing:** BYOK model API key for AI advisor ([#2380](https://github.com/0xtaos/chmonitor/issues/2380)) ([#2638](https://github.com/0xtaos/chmonitor/issues/2638)) ([9a7d684](https://github.com/0xtaos/chmonitor/commit/9a7d684acfc3988095c965c6e3fcb6cc4a19205d))
* **billing:** collect company details before Polar checkout ([#3047](https://github.com/0xtaos/chmonitor/issues/3047)) ([a1ea70d](https://github.com/0xtaos/chmonitor/commit/a1ea70d72c2a91267b09f72100ca7c3d3fab74ea))
* **billing:** count detected replicas as 0.5 billable host ([#2636](https://github.com/0xtaos/chmonitor/issues/2636)) ([cc5ad97](https://github.com/0xtaos/chmonitor/commit/cc5ad97a168c0a9610c313b517cf7a374fd3f2cc))
* **billing:** prefill checkout email + payment funnel events ([#2835](https://github.com/0xtaos/chmonitor/issues/2835)) ([af9e141](https://github.com/0xtaos/chmonitor/commit/af9e141ebad1aeb89ecfd2368201d7109dba30ea))
* **billing:** run license checkout on cloud-hooks ([#3046](https://github.com/0xtaos/chmonitor/issues/3046)) ([d174521](https://github.com/0xtaos/chmonitor/commit/d174521b11715403b5481e9a33ab646ea8a49291))
* **billing:** show licenses and drop Polar plan gate ([#3045](https://github.com/0xtaos/chmonitor/issues/3045)) ([46fa668](https://github.com/0xtaos/chmonitor/commit/46fa66837a049b80931d3044d2e072db305c0ce4))
* **blog:** add 8 SEO posts from GSC keyword expansion ([#2849](https://github.com/0xtaos/chmonitor/issues/2849)) ([9c3edfb](https://github.com/0xtaos/chmonitor/commit/9c3edfb92233549ed5b855baa6436407d2695de4))
* **blog:** list posts on marketing llms and preview on CI ([#3257](https://github.com/0xtaos/chmonitor/issues/3257)) ([aa854f8](https://github.com/0xtaos/chmonitor/commit/aa854f8e3ef4f3a2cb5ce6894d30061471ff7c8d))
* **blog:** multi-column image rows wider than the text ([#3178](https://github.com/0xtaos/chmonitor/issues/3178)) ([af2f194](https://github.com/0xtaos/chmonitor/commit/af2f19412366889842ec1c824f0c3fcdd2c9d530))
* **blog:** recap 0.3.x patches and what is next ([#3166](https://github.com/0xtaos/chmonitor/issues/3166)) ([1d6bf13](https://github.com/0xtaos/chmonitor/commit/1d6bf13823c4ec6d2f5a25b9bb69059f4374620c))
* **blog:** rewrite license post and stop counting replicas ([#3216](https://github.com/0xtaos/chmonitor/issues/3216)) ([528f7a2](https://github.com/0xtaos/chmonitor/commit/528f7a2fed077245ee90f5ac5ae2319933f0d4d2))
* **blog:** rewrite license post and stop counting replicas ([#3217](https://github.com/0xtaos/chmonitor/issues/3217)) ([995b8b4](https://github.com/0xtaos/chmonitor/commit/995b8b462a73ee3895f716f78c0778a0275139b2))
* **blog:** rewrite v0.3.3 and publish v0.3.4 ([#3167](https://github.com/0xtaos/chmonitor/issues/3167)) ([00eaf79](https://github.com/0xtaos/chmonitor/commit/00eaf79a893c8dae77e10d6d10483fbcbe10e97d))
* **blog:** zoom screenshots from a top-right control ([#3277](https://github.com/0xtaos/chmonitor/issues/3277)) ([910fc4a](https://github.com/0xtaos/chmonitor/commit/910fc4a2ee40eaf9b3acf385bffa77542e168bed))
* **brand:** rename mark assets to logo-chmonitor* and add circle avatars ([#2629](https://github.com/0xtaos/chmonitor/issues/2629)) ([3305da0](https://github.com/0xtaos/chmonitor/commit/3305da0e593bc26f37cb9abbf9bd7f646addef8b))
* **charts:** responsive month window for the query activity heatmap ([#2874](https://github.com/0xtaos/chmonitor/issues/2874)) ([4760520](https://github.com/0xtaos/chmonitor/commit/4760520d7885efcbd608db2f345a70ada3877a16))
* **ci:** clear per-component release PR titles ([#2832](https://github.com/0xtaos/chmonitor/issues/2832)) ([ae59981](https://github.com/0xtaos/chmonitor/commit/ae59981c313e10b7ca99d384d26d4373841450a3))
* **ci:** multi-component release-please — dashboard, CLI, helm chart ([#2827](https://github.com/0xtaos/chmonitor/issues/2827)) ([b59c519](https://github.com/0xtaos/chmonitor/commit/b59c51993441862b3ccaa1a47364ae66e0fed037))
* **cli:** add chm upgrade alias and explicit update fallbacks ([#3147](https://github.com/0xtaos/chmonitor/issues/3147)) ([7889840](https://github.com/0xtaos/chmonitor/commit/7889840a268ceebd16a0200955bd48e3e4a8fe90))
* **cli:** add local named connections ([#3356](https://github.com/0xtaos/chmonitor/issues/3356)) ([2209b61](https://github.com/0xtaos/chmonitor/commit/2209b611ce1ca052c416c481832d7279db63f475))
* **cli:** auth auto-detect, TUI panes, and chm/chmonitor alias ([#3185](https://github.com/0xtaos/chmonitor/issues/3185)) ([dd8db41](https://github.com/0xtaos/chmonitor/commit/dd8db416190a862ccc00ac1b9cbaf486ba75b56e))
* **cli:** chm rewrite with auth, channels, and self-hosted device login ([#3183](https://github.com/0xtaos/chmonitor/issues/3183)) ([91fefb4](https://github.com/0xtaos/chmonitor/commit/91fefb48a452defa83bea8938431f972c8914627))
* **cli:** chm update --beta switches channel and upgrades ([#3198](https://github.com/0xtaos/chmonitor/issues/3198)) ([4625b69](https://github.com/0xtaos/chmonitor/commit/4625b697a25a1fd40c29fdda0225bf9419b8c927))
* **cli:** chm update — self-update from GitHub releases ([#2831](https://github.com/0xtaos/chmonitor/issues/2831)) ([ee6178b](https://github.com/0xtaos/chmonitor/commit/ee6178b426e67ec42280a5f7bcd4471a2068be89))
* **cli:** launch interactive TUI by default ([#3193](https://github.com/0xtaos/chmonitor/issues/3193)) ([8e7d9b6](https://github.com/0xtaos/chmonitor/commit/8e7d9b6d263956c8b1809fcc83093085ce0248c8))
* **cli:** make chm doctor the cluster health command ([#3190](https://github.com/0xtaos/chmonitor/issues/3190)) ([8a26be8](https://github.com/0xtaos/chmonitor/commit/8a26be8b73df86cac7e7e69cca3feec96b324b7c))
* **cli:** migrate dashboard list picker to ratatui ([#3207](https://github.com/0xtaos/chmonitor/issues/3207)) ([cd8d2f8](https://github.com/0xtaos/chmonitor/commit/cd8d2f8eb98af2fc9881faa150964ddbe39719a3))
* **cli:** one-line install script + crates.io-ready metadata ([#2699](https://github.com/0xtaos/chmonitor/issues/2699)) ([#2731](https://github.com/0xtaos/chmonitor/issues/2731)) ([347f6a7](https://github.com/0xtaos/chmonitor/commit/347f6a7ded02719893da69e0511fce7358007118))
* **cli:** overview chart TUI, dashboard list, interactive config ([#3197](https://github.com/0xtaos/chmonitor/issues/3197)) ([b47b0c7](https://github.com/0xtaos/chmonitor/commit/b47b0c7786f4f1b4be136f54e536e8923dd218f2))
* **cli:** publish ch-monitor-cli to crates.io with a chm binary ([#2745](https://github.com/0xtaos/chmonitor/issues/2745)) ([a04c665](https://github.com/0xtaos/chmonitor/commit/a04c665add92fdd4cd131d7bae0f07a495b48b99)), closes [#2699](https://github.com/0xtaos/chmonitor/issues/2699)
* **cli:** serve installer from chmonitor.dev/install.sh ([#2826](https://github.com/0xtaos/chmonitor/issues/2826)) ([8c2122e](https://github.com/0xtaos/chmonitor/commit/8c2122e030773ae13d648958c6dd756977110780))
* **cloud-hooks:** DAU/MAU, weekly report, and new-issue Telegram alerts ([#2836](https://github.com/0xtaos/chmonitor/issues/2836)) ([78b8c14](https://github.com/0xtaos/chmonitor/commit/78b8c14ddc925c762967301de41a581922162cfe))
* **cloud-hooks:** outage escalation, error spikes, DAU anomaly + fix dropped alerts ([#2837](https://github.com/0xtaos/chmonitor/issues/2837)) ([0edaf8f](https://github.com/0xtaos/chmonitor/commit/0edaf8f4fadddb7f04ecd2025ad05b7d1c8fc003))
* **command-palette:** databases/tables, recent items, quick actions ([#2776](https://github.com/0xtaos/chmonitor/issues/2776)) ([e5c89b4](https://github.com/0xtaos/chmonitor/commit/e5c89b40ac11550ab669375592f64c64dd835568)), closes [#2768](https://github.com/0xtaos/chmonitor/issues/2768)
* **dashboard:** add friendly What's new notes for dialog and changelog ([#3140](https://github.com/0xtaos/chmonitor/issues/3140)) ([83d8d11](https://github.com/0xtaos/chmonitor/commit/83d8d112b5aded50ab7a1600b9f5e10ff80936f7))
* **dashboard:** add role workspace presets in Settings ([#3081](https://github.com/0xtaos/chmonitor/issues/3081)) ([5996bd5](https://github.com/0xtaos/chmonitor/commit/5996bd570fe8f5901d584e698bb16f969cc0a672))
* **dashboard:** add search palette tabs, page tree, and highlights ([#3245](https://github.com/0xtaos/chmonitor/issues/3245)) ([d61a50d](https://github.com/0xtaos/chmonitor/commit/d61a50d12a17ca340380c9a3ec4502d813c1fa1f))
* **dashboard:** add Tools sidebar group ([#3115](https://github.com/0xtaos/chmonitor/issues/3115)) ([#3116](https://github.com/0xtaos/chmonitor/issues/3116)) ([8439ec9](https://github.com/0xtaos/chmonitor/commit/8439ec99e11a8cf4bf6416d5b2efceda32d94e89))
* **dashboard:** compare schema/settings across nodes with one-host preview ([#3131](https://github.com/0xtaos/chmonitor/issues/3131)) ([6c8c7eb](https://github.com/0xtaos/chmonitor/commit/6c8c7eb74db28f180e6cf975b0eead0f507271f7))
* **dashboard:** compare table schemas and recommend a copy-only plan ([#3080](https://github.com/0xtaos/chmonitor/issues/3080)) ([2e39eab](https://github.com/0xtaos/chmonitor/commit/2e39eab080e7bfc4a3e16f6c667345fa3b377a8e)), closes [#3072](https://github.com/0xtaos/chmonitor/issues/3072) [#3073](https://github.com/0xtaos/chmonitor/issues/3073)
* **dashboard:** customize sidebar from settings menu tree ([#3105](https://github.com/0xtaos/chmonitor/issues/3105)) ([ecacb6d](https://github.com/0xtaos/chmonitor/commit/ecacb6d6f85ec7792bf0c3c058c505f1ba9bddbc))
* **dashboard:** enable AI insights on demo for anonymous visitors ([#3210](https://github.com/0xtaos/chmonitor/issues/3210)) ([3fbd5b9](https://github.com/0xtaos/chmonitor/commit/3fbd5b9a556e784ad39c4eae7d3009b3b615f71b))
* **dashboard:** Essential first-run sidebar with hover-add and More flyout ([#3345](https://github.com/0xtaos/chmonitor/issues/3345)) ([2e83247](https://github.com/0xtaos/chmonitor/commit/2e832479649df44316e3e75197f7cd54063fae17))
* **dashboard:** Essential heading dialog to add/remove group children ([#3353](https://github.com/0xtaos/chmonitor/issues/3353)) ([0f582f0](https://github.com/0xtaos/chmonitor/commit/0f582f0d17a05afa93c3a170c8aefdc6eb4bc2bf))
* **dashboard:** hide sidebar pages from the menu with undo toast ([#3124](https://github.com/0xtaos/chmonitor/issues/3124)) ([3322e58](https://github.com/0xtaos/chmonitor/commit/3322e58928649f21a2cf6a139552e6e5dacac0bc))
* **dashboard:** interactive cluster topology drag and glass glyphs ([#2854](https://github.com/0xtaos/chmonitor/issues/2854)) ([7bc7d67](https://github.com/0xtaos/chmonitor/commit/7bc7d676f108dd439bf9d478b67e9740165c64a2))
* **dashboard:** move Tools group to end of main menu ([#3118](https://github.com/0xtaos/chmonitor/issues/3118)) ([a9e83a0](https://github.com/0xtaos/chmonitor/commit/a9e83a011cd9a476837e4329e9d050c462b55912))
* **dashboard:** polish search, what's new, settings, and mobile nav ([#3248](https://github.com/0xtaos/chmonitor/issues/3248)) ([296f48f](https://github.com/0xtaos/chmonitor/commit/296f48f56fbb2a42ebb35282b598be001eb51f7e))
* **dashboard:** remove unused Organization page ([#3085](https://github.com/0xtaos/chmonitor/issues/3085)) ([a530565](https://github.com/0xtaos/chmonitor/commit/a530565dea85198f821ada85151df0c00da3b68a))
* **dashboard:** slim default sidebar to day-to-day pages ([#3294](https://github.com/0xtaos/chmonitor/issues/3294)) ([766e90e](https://github.com/0xtaos/chmonitor/commit/766e90ed4be595a03cf7871f5561cc65493b773e))
* **dashboard:** TTL and partition health inventory ([#3082](https://github.com/0xtaos/chmonitor/issues/3082)) ([93927b2](https://github.com/0xtaos/chmonitor/commit/93927b2b8d2f6e3f1025aabcfc827f81b218ffa8))
* **dashboard:** What's new changelog dialog next to Settings ([#3126](https://github.com/0xtaos/chmonitor/issues/3126)) ([e66ab85](https://github.com/0xtaos/chmonitor/commit/e66ab851f089a6e10d7c4f1ac3897f4c14814f95))
* **design:** illustration system — empty states, chart errors, connection panel ([#2806](https://github.com/0xtaos/chmonitor/issues/2806)) ([#2817](https://github.com/0xtaos/chmonitor/issues/2817)) ([258f826](https://github.com/0xtaos/chmonitor/commit/258f826e938f18aa56275bb43b339b62d61f7c8a))
* **docs:** add Home and Dashboard CTAs on every docs page ([#3378](https://github.com/0xtaos/chmonitor/issues/3378)) ([176ee6b](https://github.com/0xtaos/chmonitor/commit/176ee6b599bb8ce7e380b4dc543bace702ea1514)), closes [#3376](https://github.com/0xtaos/chmonitor/issues/3376)
* **explorer:** make the table Overview tab engine-aware and denser ([#2871](https://github.com/0xtaos/chmonitor/issues/2871)) ([b6a8c6a](https://github.com/0xtaos/chmonitor/commit/b6a8c6a44b64c6d461011d256a6f4e6520489b99))
* **explorer:** show table schema advisor on overview ([#3079](https://github.com/0xtaos/chmonitor/issues/3079)) ([d4a0cd6](https://github.com/0xtaos/chmonitor/commit/d4a0cd616e414ca323d2486eda2f5091cc464168))
* **explorer:** sql syntax highlight for ddl ([#2872](https://github.com/0xtaos/chmonitor/issues/2872)) ([34ed2b3](https://github.com/0xtaos/chmonitor/commit/34ed2b3f0393f911c040b9719114316821c45082))
* **fleet:** add fleet summary strip, richer host metrics and sparklines ([#2880](https://github.com/0xtaos/chmonitor/issues/2880)) ([15332e7](https://github.com/0xtaos/chmonitor/commit/15332e7620f534a56c1062c79f6d6008ecb2722c))
* **health:** dedicated Alert Settings page ([#2758](https://github.com/0xtaos/chmonitor/issues/2758)) ([f416b0f](https://github.com/0xtaos/chmonitor/commit/f416b0fdb8dec17f572bdce4a18f4f27ba5e4e74))
* **health:** group sweep alerts into per-target digests ([#2663](https://github.com/0xtaos/chmonitor/issues/2663)) ([#2748](https://github.com/0xtaos/chmonitor/issues/2748)) ([f0c0c3a](https://github.com/0xtaos/chmonitor/commit/f0c0c3a5b28ce5a184c28c15f07f3020da9dd692))
* **health:** health settings page + bento alert-settings hero ([#2759](https://github.com/0xtaos/chmonitor/issues/2759)) ([ff2483b](https://github.com/0xtaos/chmonitor/commit/ff2483b0cff6ae37c2af612d9f3d4208506afe98))
* **health:** per-channel alert settings — min severity + enable/disable ([#2661](https://github.com/0xtaos/chmonitor/issues/2661)) ([#2746](https://github.com/0xtaos/chmonitor/issues/2746)) ([8401df2](https://github.com/0xtaos/chmonitor/commit/8401df2fcde4aaaba5bf1abdb0bab89efe733ab5))
* **health:** predictive parts-pressure early warning ([#2763](https://github.com/0xtaos/chmonitor/issues/2763)) ([#2772](https://github.com/0xtaos/chmonitor/issues/2772)) ([7f3ec6f](https://github.com/0xtaos/chmonitor/commit/7f3ec6f90020c679bea7178f322d0cb1e7314ece))
* **health:** unified server-persisted alert channel config ([#2747](https://github.com/0xtaos/chmonitor/issues/2747)) ([ba328b8](https://github.com/0xtaos/chmonitor/commit/ba328b8fbb50cb8c2a0171c6e87b822353566f28))
* **helm:** add CRON_SECRET + K8s CronJob resources for Node/K8s cron parity ([#2305](https://github.com/0xtaos/chmonitor/issues/2305) PR4) ([#2633](https://github.com/0xtaos/chmonitor/issues/2633)) ([7668881](https://github.com/0xtaos/chmonitor/commit/7668881064c871675c71ccf746b2f9f3df4819b0))
* **inbound-events:** setup dialog + smart-parse + docs; fix page-views gating explanation ([#2740](https://github.com/0xtaos/chmonitor/issues/2740)) ([ee9b144](https://github.com/0xtaos/chmonitor/commit/ee9b144b8f69abafc8b8b3d314c34e5ae885923d))
* **insights:** percentile distributions + errors/hot-tables drill-downs ([#2770](https://github.com/0xtaos/chmonitor/issues/2770)) ([6dfb9af](https://github.com/0xtaos/chmonitor/commit/6dfb9af766b56160d34a5050bd14f45d1572dfb9)), closes [#2762](https://github.com/0xtaos/chmonitor/issues/2762)
* **landing:** add /clickhouse-dashboard SEO pillar ([#3385](https://github.com/0xtaos/chmonitor/issues/3385)) ([6ff9912](https://github.com/0xtaos/chmonitor/commit/6ff9912a0b68a05061db413ea4a8e312a502d718)), closes [#3374](https://github.com/0xtaos/chmonitor/issues/3374)
* **landing:** add /clickhouse-monitoring SEO pillar ([#3384](https://github.com/0xtaos/chmonitor/issues/3384)) ([9d138f1](https://github.com/0xtaos/chmonitor/commit/9d138f18230be0466f29a0ff26b437048a878b0a)), closes [#3373](https://github.com/0xtaos/chmonitor/issues/3373)
* **landing:** add CLI page at /cli ([#3189](https://github.com/0xtaos/chmonitor/issues/3189)) ([970b8c8](https://github.com/0xtaos/chmonitor/commit/970b8c88a7aabe3c360ba0d19ed87e0dec878ae0))
* **landing:** add explicit auto/system theme mode with 3-state toggle ([#2843](https://github.com/0xtaos/chmonitor/issues/2843)) ([1999ecb](https://github.com/0xtaos/chmonitor/commit/1999ecb298fb83a36be3b19e4131212008d60f59))
* **landing:** brand downloads as per-version cards with copy-link ([#3218](https://github.com/0xtaos/chmonitor/issues/3218)) ([444807c](https://github.com/0xtaos/chmonitor/commit/444807c19afaf00b93bac57fbe5c4e8a916588a5))
* **landing:** frameless hero shot and features list ([#2760](https://github.com/0xtaos/chmonitor/issues/2760)) ([aaa474e](https://github.com/0xtaos/chmonitor/commit/aaa474ebc4bdfe6e4276a5a373a885489e51fafc))
* **landing:** hero bg to top under nav, feature-menu icons, footer tidy ([#2761](https://github.com/0xtaos/chmonitor/issues/2761)) ([763d082](https://github.com/0xtaos/chmonitor/commit/763d0827775c54dcd282d125fc9eee887be0255e))
* **landing:** hero brand backdrop + clean up orphaned hero-bg assets ([#2816](https://github.com/0xtaos/chmonitor/issues/2816)) ([b838db0](https://github.com/0xtaos/chmonitor/commit/b838db019c571754ab122cf37b73b0a0d571b63e))
* **landing:** hero latest-post pill and blog restyle ([#3154](https://github.com/0xtaos/chmonitor/issues/3154)) ([8e5dc5f](https://github.com/0xtaos/chmonitor/commit/8e5dc5fc5a833d24a806c010d7941e215ad7989d))
* **landing:** interactive CLI sample on /cli ([#3195](https://github.com/0xtaos/chmonitor/issues/3195)) ([1e1ee87](https://github.com/0xtaos/chmonitor/commit/1e1ee87d58eca3117fb8e23c5fe0c006d98d8593))
* **landing:** play v0.3 film as the hero intro ([#3050](https://github.com/0xtaos/chmonitor/issues/3050)) ([2c8c83f](https://github.com/0xtaos/chmonitor/commit/2c8c83ffea397280a21429c96c9e7d01ab8f48b9))
* **landing:** Polar donate checkout with custom amount ([#3369](https://github.com/0xtaos/chmonitor/issues/3369)) ([1119f89](https://github.com/0xtaos/chmonitor/commit/1119f897d6f29eb89f7e2d79b696140033024c2a)), closes [#3368](https://github.com/0xtaos/chmonitor/issues/3368)
* **landing:** pricing link in nav + customers cards ([#3215](https://github.com/0xtaos/chmonitor/issues/3215)) ([a9bff68](https://github.com/0xtaos/chmonitor/commit/a9bff68568bf4aea2daa09031a891efc17a28169))
* **landing:** rename Pricing to License and add donate chips ([#3367](https://github.com/0xtaos/chmonitor/issues/3367)) ([a81f892](https://github.com/0xtaos/chmonitor/commit/a81f89278fa6f0c116f9f1092da3aeaa744e2681)), closes [#3366](https://github.com/0xtaos/chmonitor/issues/3366)
* **landing:** render the boss pitch as an email draft ([#3048](https://github.com/0xtaos/chmonitor/issues/3048)) ([42e6b47](https://github.com/0xtaos/chmonitor/commit/42e6b47a42f0826e3921617898afd817d2f3cfc8))
* **landing:** rework hero — star count in nav, theme toggle in footer ([#2780](https://github.com/0xtaos/chmonitor/issues/2780)) ([1d2b0d2](https://github.com/0xtaos/chmonitor/commit/1d2b0d2a9a4fb3cf2bb37b6ec0384c47e1a704bd))
* **landing:** rotate overview hero between two with-background screenshots ([#2627](https://github.com/0xtaos/chmonitor/issues/2627)) ([cbec3f9](https://github.com/0xtaos/chmonitor/commit/cbec3f95147de78b54c9657e36c7dff3ed959cb3))
* **landing:** shadcn-style nav and buttons, detailed feature pages ([#2641](https://github.com/0xtaos/chmonitor/issues/2641)) ([8ba8e87](https://github.com/0xtaos/chmonitor/commit/8ba8e879c99fcf6d6a9858117a7fc3c7b3effc7a))
* **landing:** sticky frameless nav, compact capability grid, comparison rows ([#2755](https://github.com/0xtaos/chmonitor/issues/2755)) ([465408f](https://github.com/0xtaos/chmonitor/commit/465408f232e35f78c7f9bef5e459a01253a92837))
* **landing:** traffic feature page, changelog screenshots, traffic docs presets ([#2750](https://github.com/0xtaos/chmonitor/issues/2750)) ([f2fef37](https://github.com/0xtaos/chmonitor/commit/f2fef37cb2bac2109f4fd562b853770b229f6ec7))
* **landing:** wider features menu, clamp descriptions, add overview and storage pages ([#2643](https://github.com/0xtaos/chmonitor/issues/2643)) ([41cc23f](https://github.com/0xtaos/chmonitor/commit/41cc23f8c2580e974aba64aa7eb437c46acf09cd))
* **mcp:** add Parallel Search server preset ([#3227](https://github.com/0xtaos/chmonitor/issues/3227)) ([7167715](https://github.com/0xtaos/chmonitor/commit/7167715e3313d1ce0ca0f7246496cc33bcd3e393))
* **mcp:** rate-limit the standalone MCP worker ([#2742](https://github.com/0xtaos/chmonitor/issues/2742)) ([5341363](https://github.com/0xtaos/chmonitor/commit/534136397af8733ad935cf3de033cccfef1c99e8)), closes [#2728](https://github.com/0xtaos/chmonitor/issues/2728)
* **mcp:** real Playground client + 2026-07-28 spec gaps + /mcp redesign ([#2882](https://github.com/0xtaos/chmonitor/issues/2882)) ([2d5ef1b](https://github.com/0xtaos/chmonitor/commit/2d5ef1b5e9b1d4eac7c1fe01644d02c2f2e2e0d1))
* **menu:** alert settings entry — /health?settings=alerts deep link opens dialog ([#2756](https://github.com/0xtaos/chmonitor/issues/2756)) ([0908b59](https://github.com/0xtaos/chmonitor/commit/0908b59188ed60dbc89bfdd6af63edba2ecfbcfe))
* **menu:** dim metadata-db-dependent menu items when no D1/Postgres configured ([#2812](https://github.com/0xtaos/chmonitor/issues/2812)) ([39701c6](https://github.com/0xtaos/chmonitor/commit/39701c69dfa9c5ff1ca0c5f9a32a41fc0da21271))
* **merges:** show recently completed merges when none are running ([#3033](https://github.com/0xtaos/chmonitor/issues/3033)) ([c9cdcdc](https://github.com/0xtaos/chmonitor/commit/c9cdcdc74a9b630d9aaa942f783fb5b68abef69c))
* **metrics:** memory & CPU deep-dive charts ([#2766](https://github.com/0xtaos/chmonitor/issues/2766)) ([#2774](https://github.com/0xtaos/chmonitor/issues/2774)) ([e338b1e](https://github.com/0xtaos/chmonitor/commit/e338b1ed1eb2752a1f62fbed41ce2c25bcf9fcb1))
* **mutations:** surface parts_postpone_reasons (ClickHouse 26.2+) ([#2864](https://github.com/0xtaos/chmonitor/issues/2864)) ([5ae5761](https://github.com/0xtaos/chmonitor/commit/5ae5761d8f4fd8787f7270a3d8b9efd8ebde88c5))
* **nav:** drag to reorder pinned favorites ([#3026](https://github.com/0xtaos/chmonitor/issues/3026)) ([f5c5fb1](https://github.com/0xtaos/chmonitor/commit/f5c5fb180bca5791f0033563350f74652559d57a))
* **nav:** pin favorite menu items (browser-local) ([#2778](https://github.com/0xtaos/chmonitor/issues/2778)) ([4efb966](https://github.com/0xtaos/chmonitor/commit/4efb966b410e9fb8090da3b5cae254ade8e39706))
* **og:** shared dune-plate social cards for all public surfaces ([#3254](https://github.com/0xtaos/chmonitor/issues/3254)) ([33e1689](https://github.com/0xtaos/chmonitor/commit/33e168911deec4367f57d09c8e627eaada64a85b))
* **oss:** Postgres and ClickHouse state backends for self-hosted deployments ([#2813](https://github.com/0xtaos/chmonitor/issues/2813)) ([a35f3c7](https://github.com/0xtaos/chmonitor/commit/a35f3c7b72fce5b0e73522222b3a70d27c7b402d))
* **peerdb:** group jobs by prefix and cache fleet totals ([#3176](https://github.com/0xtaos/chmonitor/issues/3176)) ([e470fcb](https://github.com/0xtaos/chmonitor/commit/e470fcbf916feccf94b3e6c72168bb99a9bb57a1))
* **pricing:** switch to self-hosted commercial licenses ([#3044](https://github.com/0xtaos/chmonitor/issues/3044)) ([2c32b6b](https://github.com/0xtaos/chmonitor/commit/2c32b6bbe320c283479775a36686f64a48e2ec1d))
* **reports:** data-rich redesigned reports with SVG sparklines and fleet report ([#2814](https://github.com/0xtaos/chmonitor/issues/2814)) ([c6db449](https://github.com/0xtaos/chmonitor/commit/c6db449472adc54ad19157506e285e96f3d267e7))
* **reports:** scheduled cluster health reports ([#2783](https://github.com/0xtaos/chmonitor/issues/2783)) ([#2796](https://github.com/0xtaos/chmonitor/issues/2796)) ([1753aa5](https://github.com/0xtaos/chmonitor/commit/1753aa5c58c45a4a5e2a829864e26caefb6d09c1))
* **reports:** scheduled insights reports + PDF export via Browser Rendering ([#2818](https://github.com/0xtaos/chmonitor/issues/2818)) ([7907b74](https://github.com/0xtaos/chmonitor/commit/7907b74b4846010e480a2895fd5338231dd02562))
* **schema-diff:** compact compare layout with pretty SQL diffs ([#3184](https://github.com/0xtaos/chmonitor/issues/3184)) ([5ca3416](https://github.com/0xtaos/chmonitor/commit/5ca341656ccab7f2b077734141dde5af74ccf091))
* **seo:** dedicated watch pages for launch films ([#3261](https://github.com/0xtaos/chmonitor/issues/3261)) ([d4dfd0b](https://github.com/0xtaos/chmonitor/commit/d4dfd0b8a842fd7a51c1dcf3fc91af833dae4357))
* **seo:** list every public URL in sitemap.xml and llms.txt ([#3256](https://github.com/0xtaos/chmonitor/issues/3256)) ([ca4dc16](https://github.com/0xtaos/chmonitor/commit/ca4dc16c855159eb8cf745504283b8268fd8f1dc))
* **settings-diff:** use full data table toolbar ([#3186](https://github.com/0xtaos/chmonitor/issues/3186)) ([098e862](https://github.com/0xtaos/chmonitor/commit/098e8625d8d3bde8b0ba474d331746e572ed91c0))
* **telemetry:** CLI telemetry stream + analytics dashboard ([#2833](https://github.com/0xtaos/chmonitor/issues/2833)) ([b13ca71](https://github.com/0xtaos/chmonitor/commit/b13ca7111dcbaba1179d92407254e39a68df5565))
* **telemetry:** enhance privacy note and add disable-tracking instructions to landing page ([#2739](https://github.com/0xtaos/chmonitor/issues/2739)) ([a231aec](https://github.com/0xtaos/chmonitor/commit/a231aec7e45d021d7554acff35afa903938a2bca))
* **telemetry:** match landing chrome and fix row logos ([#3244](https://github.com/0xtaos/chmonitor/issues/3244)) ([24ca7e8](https://github.com/0xtaos/chmonitor/commit/24ca7e83385194d70e7b08e39a2668088b8f928b))
* **telemetry:** redesign public stats page — layout, logos, dithered bars ([#3226](https://github.com/0xtaos/chmonitor/issues/3226)) ([5c34e15](https://github.com/0xtaos/chmonitor/commit/5c34e152a68207f95b02df45949f32d111cd917c))
* **telemetry:** send CHM_LICENSE_KEY on instance ping ([#3142](https://github.com/0xtaos/chmonitor/issues/3142)) ([a65e146](https://github.com/0xtaos/chmonitor/commit/a65e146925de0c68237728536c90ba0e40174ce2))
* **telemetry:** simplify analytics page with dashboard vs CLI tabs ([#2834](https://github.com/0xtaos/chmonitor/issues/2834)) ([51aa174](https://github.com/0xtaos/chmonitor/commit/51aa174a80bd3350408160a60c95b7e2f046ddf7))
* **traffic:** auto-detected PeerDB ingestion section ([#2649](https://github.com/0xtaos/chmonitor/issues/2649)) ([232a13a](https://github.com/0xtaos/chmonitor/commit/232a13aa043c1b997b9910a8d2f8ddb677daa260))
* **traffic:** cluster traffic page with ingestion charts and KPIs ([#2644](https://github.com/0xtaos/chmonitor/issues/2644)) ([ab039a7](https://github.com/0xtaos/chmonitor/commit/ab039a71e8231161e6f0cc923da3c79ccda608a6))
* **traffic:** ingest speed, disk write speed, and PeerDB bytes/performance charts ([#2753](https://github.com/0xtaos/chmonitor/issues/2753)) ([dc313bc](https://github.com/0xtaos/chmonitor/commit/dc313bc9db55033373dc0c50489126c76748d3c5))
* **traffic:** insert performance chart — avg and p95 insert duration ([#2752](https://github.com/0xtaos/chmonitor/issues/2752)) ([c46b436](https://github.com/0xtaos/chmonitor/commit/c46b436c36b0e71ad059765bf9037eef6b02e819))
* **traffic:** merge and data movement volume charts ([#2646](https://github.com/0xtaos/chmonitor/issues/2646)) ([3b593bd](https://github.com/0xtaos/chmonitor/commit/3b593bdcda6f32bf242de69b67d37255c9101ed9))
* **traffic:** p99 latency, legend toggle, zoom dialog grid, density ([#2795](https://github.com/0xtaos/chmonitor/issues/2795)) ([3aae7cd](https://github.com/0xtaos/chmonitor/commit/3aae7cd021f8e3ef4571003a6c1a49cbbde171fc))
* **traffic:** per-table ingestion breakdown and compression ratio ([#2645](https://github.com/0xtaos/chmonitor/issues/2645)) ([c9d3d4f](https://github.com/0xtaos/chmonitor/commit/c9d3d4fb7f461953efd54036fec35ec551f1f592))
* **traffic:** smart-detected replication and distribution section ([#2647](https://github.com/0xtaos/chmonitor/issues/2647)) ([8fce7d1](https://github.com/0xtaos/chmonitor/commit/8fce7d1d894bd01830250b3785466ff4ea980234))
* **traffic:** view settings, presets, and part_log auto-hide ([#2654](https://github.com/0xtaos/chmonitor/issues/2654)) ([b6f0998](https://github.com/0xtaos/chmonitor/commit/b6f09982e8f09e6c3965bb0e7975f8c5cd8cc094))
* **ttl:** show in-range vs past-TTL bytes on inventory ([#3274](https://github.com/0xtaos/chmonitor/issues/3274)) ([adf767a](https://github.com/0xtaos/chmonitor/commit/adf767af5ee7dc670da45a0529834c72e30fa269))
* **ui:** add settings icon next to sign-in and avatar ([#3018](https://github.com/0xtaos/chmonitor/issues/3018)) ([0192a41](https://github.com/0xtaos/chmonitor/commit/0192a4114904725a361cfb889d999934a5f18371))


### 🐛 Bug Fixes

* **a11y:** accessible names for icon-only buttons ([#2711](https://github.com/0xtaos/chmonitor/issues/2711)) ([b0087b3](https://github.com/0xtaos/chmonitor/commit/b0087b33256bd275e4f12473291b11c228c3cbb1))
* **a11y:** ARIA tree semantics + keyboard navigation for database explorer ([#2686](https://github.com/0xtaos/chmonitor/issues/2686)) ([#2736](https://github.com/0xtaos/chmonitor/issues/2736)) ([766a397](https://github.com/0xtaos/chmonitor/commit/766a39712959d57097ac941c82ff26ae476e30f5))
* add clipboard fallback for unsupported environments ([e49630d](https://github.com/0xtaos/chmonitor/commit/e49630d9bc7d8ffd1d211359a47030939f5e488f))
* **advisor:** batch correctness, sanitization, and weekly report integration ([#3340](https://github.com/0xtaos/chmonitor/issues/3340)) ([27d6b7d](https://github.com/0xtaos/chmonitor/commit/27d6b7da9638b70443210690234dbc75caf7875b))
* **advisor:** stop aggregating event_time in the history picker WHERE ([#3146](https://github.com/0xtaos/chmonitor/issues/3146)) ([22de145](https://github.com/0xtaos/chmonitor/commit/22de145a2f336ccbe858f4a906e44c5941cfe368))
* **advisor:** treat table-less SQL as a guided empty state ([#3148](https://github.com/0xtaos/chmonitor/issues/3148)) ([a8126c8](https://github.com/0xtaos/chmonitor/commit/a8126c8950f70f0fa9c329408f0a3908a4640c1f))
* **agent:** cap the tool loop at 16 steps ([#3056](https://github.com/0xtaos/chmonitor/issues/3056)) ([362ae03](https://github.com/0xtaos/chmonitor/commit/362ae0386b110505fc76d77b319ffcd3cfb783d9))
* **agent:** default cloud guests to LongCat and cover every tool ([#3070](https://github.com/0xtaos/chmonitor/issues/3070)) ([4410109](https://github.com/0xtaos/chmonitor/commit/4410109e5e03f7cacdece2fd559f8befb0d8b10a))
* **agent:** fix first-message-of-session failure, stop masking tool errors ([#3039](https://github.com/0xtaos/chmonitor/issues/3039)) ([11cf5e0](https://github.com/0xtaos/chmonitor/commit/11cf5e09c010e5c1fedfc8026aff746a2b923dc4))
* **agent:** hide unconfigured providers and parse chat auth errors ([#2869](https://github.com/0xtaos/chmonitor/issues/2869)) ([f0ca2fa](https://github.com/0xtaos/chmonitor/commit/f0ca2fa3984e2a70660897e96f4ab8a60db9e1e8))
* **agent:** keep tool loop after first call and persist AgentState titles ([#3064](https://github.com/0xtaos/chmonitor/issues/3064)) ([764045f](https://github.com/0xtaos/chmonitor/commit/764045ffb115b0ddd7395ee18d281bc30da61263))
* **agents:** collapse conversation rail by default on small screens ([#2879](https://github.com/0xtaos/chmonitor/issues/2879)) ([c402bd6](https://github.com/0xtaos/chmonitor/commit/c402bd6a29131af065fa13ed19ac554fd930525f))
* **agents:** compact composer footer, fix conversation rail default ([#3037](https://github.com/0xtaos/chmonitor/issues/3037)) ([bc39915](https://github.com/0xtaos/chmonitor/commit/bc39915826b7c58a3f0f6132c9b6bc4015485c83))
* **agent:** show AnyRouter sign-in only when no ANYROUTER_API_KEY is set ([#2983](https://github.com/0xtaos/chmonitor/issues/2983)) ([b2c71ea](https://github.com/0xtaos/chmonitor/commit/b2c71ea82c9ef88e16192f92cb4ebb273ec6e440))
* **agents:** model picker overflow + search, opaque conversations button, billing card ([#2623](https://github.com/0xtaos/chmonitor/issues/2623)) ([a218214](https://github.com/0xtaos/chmonitor/commit/a218214ad0ff86be77e43e111400f9458ea2cb51))
* **agents:** polish tool-call rendering and assistant markdown styling ([#3041](https://github.com/0xtaos/chmonitor/issues/3041)) ([ca32930](https://github.com/0xtaos/chmonitor/commit/ca32930a9a14fe312764c5c1618a1fa09abe26f0))
* **agent:** tighten loop prompt and primitive tools ([#3053](https://github.com/0xtaos/chmonitor/issues/3053)) ([3db8773](https://github.com/0xtaos/chmonitor/commit/3db87733f866da81175e221dc4fe11efa6f35b72))
* **agent:** tighten system prompt tool order, error recovery, answer shape ([#3036](https://github.com/0xtaos/chmonitor/issues/3036)) ([09bed4e](https://github.com/0xtaos/chmonitor/commit/09bed4eb0352dd41b24568844dbd4a3c23762cdc))
* **ai:** break mv-designer module's circular type imports ([#2963](https://github.com/0xtaos/chmonitor/issues/2963)) ([252555f](https://github.com/0xtaos/chmonitor/commit/252555fef0e2c4565f4cdf68aa6dbd86fba58e95))
* **api:** enforce readonly='1' string type in ClickHouse settings ([#3230](https://github.com/0xtaos/chmonitor/issues/3230)) ([a137e9d](https://github.com/0xtaos/chmonitor/commit/a137e9d85bbed451d2d09e72d8c090623a8eefd0))
* **api:** rate limit browser-connections test and sessions routes ([#2979](https://github.com/0xtaos/chmonitor/issues/2979)) ([a8bafc5](https://github.com/0xtaos/chmonitor/commit/a8bafc5364856c6432556563bf42e4eeea3da08e)), closes [#2978](https://github.com/0xtaos/chmonitor/issues/2978)
* **api:** remove bogus overflow_mode setting, add any-version fallback + live CI test ([#2651](https://github.com/0xtaos/chmonitor/issues/2651)) ([9c6e2e8](https://github.com/0xtaos/chmonitor/commit/9c6e2e820f44a63e4383cbd1dac4e6c8146c5cce))
* **auth:** harden device/cron/api-key surfaces and add route tests ([#3339](https://github.com/0xtaos/chmonitor/issues/3339)) ([c08807d](https://github.com/0xtaos/chmonitor/commit/c08807d02cd9b6e4fa5afff625aa17bd9b705983))
* batch of triaged bugs and docs fixes ([#2713](https://github.com/0xtaos/chmonitor/issues/2713)) ([6a3c247](https://github.com/0xtaos/chmonitor/commit/6a3c247ecae544ca6e94ba1400b7dee6a18fad99))
* **billing:** count org seats from Clerk totalCount, not the first page ([#2923](https://github.com/0xtaos/chmonitor/issues/2923)) ([e83f490](https://github.com/0xtaos/chmonitor/commit/e83f49070ad327a40097ff6e7806d492391a9f8f))
* **blog:** correct future-dated posts and guard latest/llms.txt against them ([#2730](https://github.com/0xtaos/chmonitor/issues/2730)) ([2e4eb7c](https://github.com/0xtaos/chmonitor/commit/2e4eb7cdaff0b1dc0acba1f27a76933107372ef9)), closes [#2697](https://github.com/0xtaos/chmonitor/issues/2697)
* **blog:** give screenshot rows a shared height ([#3275](https://github.com/0xtaos/chmonitor/issues/3275)) ([d4b55d7](https://github.com/0xtaos/chmonitor/commit/d4b55d772ec2f7def37b6c3dac967f508a56e6d2))
* **blog:** hide Features/Open source/RSS and show GitHub stars ([#3159](https://github.com/0xtaos/chmonitor/issues/3159)) ([597c5f3](https://github.com/0xtaos/chmonitor/commit/597c5f3d80210c531495688ff4fe7e025c397567))
* **blog:** hover-only zoom icon and full-width lone screenshots ([#3279](https://github.com/0xtaos/chmonitor/issues/3279)) ([9cd5bba](https://github.com/0xtaos/chmonitor/commit/9cd5bba244bfbdbcb2081fd768505f770a683d38))
* **blog:** move postgres monitoring beta into Feature ([#3162](https://github.com/0xtaos/chmonitor/issues/3162)) ([881ff63](https://github.com/0xtaos/chmonitor/commit/881ff63b5356535a9b2398c9831fbd6c3c2baeb7))
* **blog:** pass host/port to astro preview without extra -- ([#3258](https://github.com/0xtaos/chmonitor/issues/3258)) ([709a8a7](https://github.com/0xtaos/chmonitor/commit/709a8a7dd7e97821c67e57d7b03f4fb7322a31dd))
* **blog:** publish customize-dashboard on 2026-08-19 ([#3161](https://github.com/0xtaos/chmonitor/issues/3161)) ([306add6](https://github.com/0xtaos/chmonitor/commit/306add69e51c5c54eeb9d1e6517d59f6b0a14a01))
* **blog:** reuse the landing nav and styles ([#3160](https://github.com/0xtaos/chmonitor/issues/3160)) ([fb846bb](https://github.com/0xtaos/chmonitor/commit/fb846bb6640c2b93eb09c6d090ea73ed69fe58ec))
* **blog:** stop header nav links wrapping and overflowing ([#3158](https://github.com/0xtaos/chmonitor/issues/3158)) ([1bb4b64](https://github.com/0xtaos/chmonitor/commit/1bb4b647231f6ecf8c13995261d56d81625a12dc))
* **blog:** un-squash post images, widen them past the text column ([#2625](https://github.com/0xtaos/chmonitor/issues/2625)) ([e52924d](https://github.com/0xtaos/chmonitor/commit/e52924d2f226d9e1421d7606d6951661b78e9c6b))
* **brand:** generate logo SVGs for blog and docs apps ([#2631](https://github.com/0xtaos/chmonitor/issues/2631)) ([3ca2575](https://github.com/0xtaos/chmonitor/commit/3ca2575844046cffb96cd9a4573972fd99cc7b89))
* **brand:** resolve docs smoke crawl 404 error and fix avatar scaling ([#2630](https://github.com/0xtaos/chmonitor/issues/2630)) ([fe6c7c8](https://github.com/0xtaos/chmonitor/commit/fe6c7c8c9d351f0f77854c30de80893fd0c16167))
* **charts:** degrade optional charts when a metric_log column is missing ([#3007](https://github.com/0xtaos/chmonitor/issues/3007)) ([523fb99](https://github.com/0xtaos/chmonitor/commit/523fb99f0027d91188a08bd362d4fac48f09bf77))
* **charts:** drop stale 'last year' wording from the heatmap empty state ([#2878](https://github.com/0xtaos/chmonitor/issues/2878)) ([e299cd2](https://github.com/0xtaos/chmonitor/commit/e299cd2356acfbef80542c953c5c4201aa02d7c6))
* **charts:** keep area fill when log scale is enabled ([#2981](https://github.com/0xtaos/chmonitor/issues/2981)) ([ab143fc](https://github.com/0xtaos/chmonitor/commit/ab143fc7477112065b7505613a89bedab4887422))
* **charts:** pad heatmap months left to fill width ([#3017](https://github.com/0xtaos/chmonitor/issues/3017)) ([fc34acc](https://github.com/0xtaos/chmonitor/commit/fc34acc321f805c4801ec42be607d75b4f2ff8e6))
* **charts:** polish Top Tables by Size toggle and scrollbar ([#2877](https://github.com/0xtaos/chmonitor/issues/2877)) ([9acde14](https://github.com/0xtaos/chmonitor/commit/9acde14bf60090a0d7b8f8549821312a7b140d70))
* **charts:** remove default black axis line from bar charts ([#2876](https://github.com/0xtaos/chmonitor/issues/2876)) ([d2731cc](https://github.com/0xtaos/chmonitor/commit/d2731ccbb651d9595045b36e005c42840621e15a))
* **charts:** reserve close-button space in chart-zoom header ([#2799](https://github.com/0xtaos/chmonitor/issues/2799)) ([27b3405](https://github.com/0xtaos/chmonitor/commit/27b3405e2fb386083b13f232bd7fbc31ad185c4c))
* **ci:** do not cancel in-flight main deploys ([#3006](https://github.com/0xtaos/chmonitor/issues/3006)) ([823e767](https://github.com/0xtaos/chmonitor/commit/823e767cec66dc6734fc8bcb15109ae0c9b58e12))
* **ci:** harden workflows — pipefail on manifest step, pnpm caching, frozen-lockfile ([#2910](https://github.com/0xtaos/chmonitor/issues/2910)) ([976bf78](https://github.com/0xtaos/chmonitor/commit/976bf782a37a4339f0be1ad3efcd83b2de34328f)), closes [#2901](https://github.com/0xtaos/chmonitor/issues/2901) [#2890](https://github.com/0xtaos/chmonitor/issues/2890) [#2891](https://github.com/0xtaos/chmonitor/issues/2891)
* **ci:** pass CHM_POLAR_DONATE_* from cloud-hooks env on deploy ([#3370](https://github.com/0xtaos/chmonitor/issues/3370)) ([f9cc505](https://github.com/0xtaos/chmonitor/commit/f9cc50565c56dac343a9b3e25b8db5d470744a4e))
* **ci:** stop deploy jobs failing on pnpm cache, 10215 secrets order, topology cycles ([#2932](https://github.com/0xtaos/chmonitor/issues/2932)) ([5672d5e](https://github.com/0xtaos/chmonitor/commit/5672d5e77d71645fa48ed106cd9c1a3cdb836d45))
* **ci:** use shared node-based ARM64 Dockerfile for latest/release images ([#2863](https://github.com/0xtaos/chmonitor/issues/2863)) ([34ffcd3](https://github.com/0xtaos/chmonitor/commit/34ffcd3f7307f56163dea2a9349c3e8798112378)), closes [#2862](https://github.com/0xtaos/chmonitor/issues/2862)
* **cli:** assemble report metrics from the repo root ([#3357](https://github.com/0xtaos/chmonitor/issues/3357)) ([28930d8](https://github.com/0xtaos/chmonitor/commit/28930d8d3a1cf4fcbea97dd83ebfa578db0116a6))
* **cli:** body-read errors, plaintext purge, rust consumer map ([#3337](https://github.com/0xtaos/chmonitor/issues/3337)) ([5421804](https://github.com/0xtaos/chmonitor/commit/5421804554d642ee02d64ea8b1b6cbb413b671e4))
* **cli:** cap live dashboard refresh and prune today query count ([#3204](https://github.com/0xtaos/chmonitor/issues/3204)) ([971ab33](https://github.com/0xtaos/chmonitor/commit/971ab33023f7a36509874be2c84cbee1ca121d35))
* **clickhouse-client:** pool key, release leaks, credential list alignment, probe dedup ([#2961](https://github.com/0xtaos/chmonitor/issues/2961)) ([6dd137c](https://github.com/0xtaos/chmonitor/commit/6dd137cee9678157191c4a9823e11fe3323af926)), closes [#2945](https://github.com/0xtaos/chmonitor/issues/2945) [#2946](https://github.com/0xtaos/chmonitor/issues/2946) [#2947](https://github.com/0xtaos/chmonitor/issues/2947) [#2948](https://github.com/0xtaos/chmonitor/issues/2948) [#2953](https://github.com/0xtaos/chmonitor/issues/2953)
* **cli:** drop diagnose, upgrade, and completions ([#3205](https://github.com/0xtaos/chmonitor/issues/3205)) ([0f72b94](https://github.com/0xtaos/chmonitor/commit/0f72b946382266f2de9fa4ae80c9e6afb45e04a1))
* **cli:** exit after chm update and persist --beta/--stable ([#3201](https://github.com/0xtaos/chmonitor/issues/3201)) ([60b4833](https://github.com/0xtaos/chmonitor/commit/60b483388e5a085c728513e531fd406d8c590cb9))
* **cli:** find nested metrics json after artifact download ([#3243](https://github.com/0xtaos/chmonitor/issues/3243)) ([e9efda3](https://github.com/0xtaos/chmonitor/commit/e9efda30ff2d47d983e2967d21ab8df1b09e3898))
* **cli:** install.sh resolved wrong release tag from single-line JSON ([#2825](https://github.com/0xtaos/chmonitor/issues/2825)) ([ec4bc3f](https://github.com/0xtaos/chmonitor/commit/ec4bc3f81201d10a621eecdacc9589502ced7e5d))
* **clipboard:** fall back to execCommand when navigator.clipboard is unavailable ([#2974](https://github.com/0xtaos/chmonitor/issues/2974)) ([3addd0c](https://github.com/0xtaos/chmonitor/commit/3addd0c36232df04ea62fe3d2016ed1ae03fc5bf))
* **cli:** rank chm-v* tags by semver and polish upgrade UX ([#3149](https://github.com/0xtaos/chmonitor/issues/3149)) ([d62efdf](https://github.com/0xtaos/chmonitor/commit/d62efdf3477109d5c26a76a6e1412a69a5e73230))
* **cli:** rename crate to chmonitor and publish only on stable tags ([#3188](https://github.com/0xtaos/chmonitor/issues/3188)) ([6a4673e](https://github.com/0xtaos/chmonitor/commit/6a4673e219f9913b2e909e1070b472651a9ec08c))
* **cli:** route curl install.sh around Bot Fight Mode 403 ([7d97cf1](https://github.com/0xtaos/chmonitor/commit/7d97cf1546b1a43fc4142ad8bed1560763ce463c))
* **cloud-hooks:** add fleet tier to PLAN_RANK ([#2709](https://github.com/0xtaos/chmonitor/issues/2709)) ([#2712](https://github.com/0xtaos/chmonitor/issues/2712)) ([c137a1c](https://github.com/0xtaos/chmonitor/commit/c137a1cb2c9b385420c954ddf1918b15d0530247))
* **cloud-hooks:** billing hardening, logging, and dead-code cleanup ([#3342](https://github.com/0xtaos/chmonitor/issues/3342)) ([36183db](https://github.com/0xtaos/chmonitor/commit/36183db3aec991d57abe8097cb408d3eee07e6ba))
* **cloud-hooks:** break two import cycles flagged by depcruise ([#2838](https://github.com/0xtaos/chmonitor/issues/2838)) ([eff436d](https://github.com/0xtaos/chmonitor/commit/eff436d1167dc678893e13f0f261b4c60d433962))
* **cloud-hooks:** collapse to a single cron trigger to fit account cron budget ([#2866](https://github.com/0xtaos/chmonitor/issues/2866)) ([b54664c](https://github.com/0xtaos/chmonitor/commit/b54664c4fecb852aeaeb6d3b078f305bd7b01d28))
* **cloud-hooks:** detect Polar signature failures without Error.name ([#2853](https://github.com/0xtaos/chmonitor/issues/2853)) ([dd239b1](https://github.com/0xtaos/chmonitor/commit/dd239b1fedbf9614be939a832d006b86f6672d68))
* **cloud:** hard-lock cloud mode to the hosted build pipeline ([#2870](https://github.com/0xtaos/chmonitor/issues/2870)) ([5131ae9](https://github.com/0xtaos/chmonitor/commit/5131ae988bbea382d6fdb5beb096622e5cef1583))
* cluster-topology stale counter, formatBytes/Count sub-1 unit, insights long-query wording ([#2921](https://github.com/0xtaos/chmonitor/issues/2921)) ([69d7c9f](https://github.com/0xtaos/chmonitor/commit/69d7c9f160ccb59e2d93aa4867e086c8ee445e24)), closes [#2911](https://github.com/0xtaos/chmonitor/issues/2911) [#2915](https://github.com/0xtaos/chmonitor/issues/2915) [#2916](https://github.com/0xtaos/chmonitor/issues/2916)
* **compare:** keep the name filter on the listing panel ([#3172](https://github.com/0xtaos/chmonitor/issues/3172)) ([ed5710e](https://github.com/0xtaos/chmonitor/commit/ed5710ea3c1f12de2dd583c75351096ba9369fb7))
* **compare:** show listing loading when switching scope ([#3174](https://github.com/0xtaos/chmonitor/issues/3174)) ([5a310df](https://github.com/0xtaos/chmonitor/commit/5a310df467c7b93d97ed3ac45514affc736666f6))
* **dashboard:** advisor pick-query dialog empty list and layout ([#3143](https://github.com/0xtaos/chmonitor/issues/3143)) ([d2969ee](https://github.com/0xtaos/chmonitor/commit/d2969eea7f798c17a8dfd745a714786510137e75))
* **dashboard:** cap refresh fan-out and remaining perf findings ([#3153](https://github.com/0xtaos/chmonitor/issues/3153)) ([11dc029](https://github.com/0xtaos/chmonitor/commit/11dc029270fe550f09302bac00aab8c6266047b6))
* **dashboard:** center the What's new dialog in the viewport ([#3344](https://github.com/0xtaos/chmonitor/issues/3344)) ([df2d270](https://github.com/0xtaos/chmonitor/commit/df2d270f5dc38fff41017f62c0635564f8b95184))
* **dashboard:** command palette Enter activates the highlighted row ([#3350](https://github.com/0xtaos/chmonitor/issues/3350)) ([3dfd0c6](https://github.com/0xtaos/chmonitor/commit/3dfd0c625088617834aae6bd9e07c947dfbaccef))
* **dashboard:** compact 375 day switcher and scroll overview tabs ([#3293](https://github.com/0xtaos/chmonitor/issues/3293)) ([34113ac](https://github.com/0xtaos/chmonitor/commit/34113acaaa926c1a4d1f50946487e50ab6e89f3f))
* **dashboard:** drop id fallback from dynamic model descriptions ([#3213](https://github.com/0xtaos/chmonitor/issues/3213)) ([59420c5](https://github.com/0xtaos/chmonitor/commit/59420c5fe6adbf9005218dd6bc9823e01da846c1))
* **dashboard:** enlarge header utility icons to 44px on phones ([#3110](https://github.com/0xtaos/chmonitor/issues/3110)) ([75bc145](https://github.com/0xtaos/chmonitor/commit/75bc1450dfc74aa707db7a831886303548cd16b5))
* **dashboard:** finite clampLimit fallback and LRU memory cache ([#2956](https://github.com/0xtaos/chmonitor/issues/2956)) ([95cf5a0](https://github.com/0xtaos/chmonitor/commit/95cf5a04cdeddc2bf8347af53fbadfb706a77e53)), closes [#2952](https://github.com/0xtaos/chmonitor/issues/2952) [#2954](https://github.com/0xtaos/chmonitor/issues/2954)
* **dashboard:** fix query tables Actions width, colspan, and add query highlighting ([#2632](https://github.com/0xtaos/chmonitor/issues/2632)) ([9a06a86](https://github.com/0xtaos/chmonitor/commit/9a06a86536bf9c47665bb63739afba3f0663d28a))
* **dashboard:** keep Essential sidebar as parent/child groups ([#3349](https://github.com/0xtaos/chmonitor/issues/3349)) ([532fc04](https://github.com/0xtaos/chmonitor/commit/532fc040dbd34541e8b5a183a497406457aa5942))
* **dashboard:** keep header title readable at 768 ([#3297](https://github.com/0xtaos/chmonitor/issues/3297)) ([70b41df](https://github.com/0xtaos/chmonitor/commit/70b41df0e1eedcd3c95d1909d20de33ca3c30a84))
* **dashboard:** keep Navigation presets and Show all inside a 375 dialog ([#3299](https://github.com/0xtaos/chmonitor/issues/3299)) ([192a7d7](https://github.com/0xtaos/chmonitor/commit/192a7d738b3c2bd3aa3e1beaa5f65361557288bb))
* **dashboard:** keep user-settings out of the persisted query cache ([#2990](https://github.com/0xtaos/chmonitor/issues/2990)) ([dd033bd](https://github.com/0xtaos/chmonitor/commit/dd033bdbf8c72f88e60eb4753bf7e84441783068))
* **dashboard:** keep What's new notes scrolling above the footer ([#3136](https://github.com/0xtaos/chmonitor/issues/3136)) ([cfea7fd](https://github.com/0xtaos/chmonitor/commit/cfea7fd84247b99cf0e34720e44903693e5de3e8))
* **dashboard:** left-align Navigation tree and collapse on role select ([#3130](https://github.com/0xtaos/chmonitor/issues/3130)) ([66c54f2](https://github.com/0xtaos/chmonitor/commit/66c54f27ae8498b204d40743170cc00756d9280f))
* **dashboard:** load TTL partition inventory without missing ttl column ([#3122](https://github.com/0xtaos/chmonitor/issues/3122)) ([c28b127](https://github.com/0xtaos/chmonitor/commit/c28b1278afed5d910626f63a177cf060f2abb30c)), closes [#3121](https://github.com/0xtaos/chmonitor/issues/3121)
* **dashboard:** nest Inbound Events under Health ([#3134](https://github.com/0xtaos/chmonitor/issues/3134)) ([#3141](https://github.com/0xtaos/chmonitor/issues/3141)) ([717c38f](https://github.com/0xtaos/chmonitor/commit/717c38f8de95c7d66dc96b4887b2d87497f8dd85))
* **dashboard:** polish compare toolbar tabs and filters ([#3165](https://github.com/0xtaos/chmonitor/issues/3165)) ([ca27b3a](https://github.com/0xtaos/chmonitor/commit/ca27b3a267aa532d0b1ac3dc85cbdb1e11a5ec88))
* **dashboard:** publish real public OpenAPI spec ([#3114](https://github.com/0xtaos/chmonitor/issues/3114)) ([6715b9b](https://github.com/0xtaos/chmonitor/commit/6715b9bb5b4706344fdfb4a5174a7d1d4c89dc1f))
* **dashboard:** repair overview mobile and tablet layout ([#3103](https://github.com/0xtaos/chmonitor/issues/3103)) ([8c3917d](https://github.com/0xtaos/chmonitor/commit/8c3917dbae87bede07596240b4fe4769d2a8d17c))
* **dashboard:** resolve running queries alignment and responsiveness ([#2628](https://github.com/0xtaos/chmonitor/issues/2628)) ([75812e6](https://github.com/0xtaos/chmonitor/commit/75812e60e89430de6623350257f2d10eb7961ebb))
* **dashboard:** serve HTML sign-in at /sign-in ([#3102](https://github.com/0xtaos/chmonitor/issues/3102)) ([06a6d5e](https://github.com/0xtaos/chmonitor/commit/06a6d5ec5ae2cf2fb4745944959817c5be8c88f0))
* **dashboard:** serve public OpenAPI spec and API docs page ([#3101](https://github.com/0xtaos/chmonitor/issues/3101)) ([2ded655](https://github.com/0xtaos/chmonitor/commit/2ded655cd1109c8f8da0a65a19a17aa17943e1df))
* **dashboard:** show overview selected tab underline in light mode ([#3200](https://github.com/0xtaos/chmonitor/issues/3200)) ([deec925](https://github.com/0xtaos/chmonitor/commit/deec9251ecb4fc29d3e06c411875b1c588ab839b))
* **dashboard:** sidebar group + after label, chevron flush right ([#3388](https://github.com/0xtaos/chmonitor/issues/3388)) ([c6135e6](https://github.com/0xtaos/chmonitor/commit/c6135e640f11856f035e2c44fd834fa8206098d7))
* **dashboard:** sidebar overlay chrome, nested active, host-scoped cache ([#3363](https://github.com/0xtaos/chmonitor/issues/3363)) ([6253170](https://github.com/0xtaos/chmonitor/commit/62531700059335509f630b5a95cdd4f7883830f6))
* **dashboard:** wrap overview metric cards before they crush ([#3298](https://github.com/0xtaos/chmonitor/issues/3298)) ([b6a05ee](https://github.com/0xtaos/chmonitor/commit/b6a05eef46df0bc40a1c36711f6a3c75d18b7319))
* **deploy:** skip schedules API entirely — account over free cron budget ([#2868](https://github.com/0xtaos/chmonitor/issues/2868)) ([c7ca683](https://github.com/0xtaos/chmonitor/commit/c7ca6836405c55313e9298535fce7686ea6e0d1e))
* **deps:** bump ws, undici, hono, tar, @opentelemetry/core for Dependabot alerts ([#2757](https://github.com/0xtaos/chmonitor/issues/2757)) ([9001e11](https://github.com/0xtaos/chmonitor/commit/9001e115e21427c4a22a99ce047f1c674eb3acfd))
* **deps:** migrate pnpm settings and close audit batch issues ([#3338](https://github.com/0xtaos/chmonitor/issues/3338)) ([a10872a](https://github.com/0xtaos/chmonitor/commit/a10872ac6afda2229361fd74c2a19d65b2933179))
* **docs:** add a positive run_worker_first rule so CSS deploys ([#3285](https://github.com/0xtaos/chmonitor/issues/3285)) ([f04a065](https://github.com/0xtaos/chmonitor/commit/f04a0657660f7407bc5953da1c69a3c590569f84))
* **docs:** drop trailing slashes at the Workers asset layer ([#3260](https://github.com/0xtaos/chmonitor/issues/3260)) ([d568b4d](https://github.com/0xtaos/chmonitor/commit/d568b4d8aee6eebd47c613a1d045ab8812d8666f))
* **docs:** Mermaid loading placeholder while hydrating ([#3382](https://github.com/0xtaos/chmonitor/issues/3382)) ([19c0c71](https://github.com/0xtaos/chmonitor/commit/19c0c71f325d349d7ae1546deba6a8d95f1cd72c))
* **docs:** pad article Copy Markdown and Open to 44px on phones ([#3113](https://github.com/0xtaos/chmonitor/issues/3113)) ([48acba9](https://github.com/0xtaos/chmonitor/commit/48acba9f58259bb885a4d1ea4e91937737b8e986))
* **docs:** pad mobile header search and menu to 44px ([#3112](https://github.com/0xtaos/chmonitor/issues/3112)) ([dfcdccf](https://github.com/0xtaos/chmonitor/commit/dfcdccfd88bd79cc214e3317de398215182be523))
* **docs:** serve hashed CSS instead of HTML 404s ([#3284](https://github.com/0xtaos/chmonitor/issues/3284)) ([71a4b83](https://github.com/0xtaos/chmonitor/commit/71a4b83d8139bd60b1a2a3a1c52545d74c04c732))
* guard against undefined event.key in keyboard shortcut matching ([#2840](https://github.com/0xtaos/chmonitor/issues/2840)) ([9b3a1db](https://github.com/0xtaos/chmonitor/commit/9b3a1db8f3a38ae8f6396529dda755b66e24dc92))
* **health:** keep the __digest__ sentinel out of channel-config reads; atomic digest buffering ([#2749](https://github.com/0xtaos/chmonitor/issues/2749)) ([4412e49](https://github.com/0xtaos/chmonitor/commit/4412e49d2d516e6b824f67eec6f1e35fbe653ab0))
* **health:** settings dialog sizing and tab overflow ([#2653](https://github.com/0xtaos/chmonitor/issues/2653)) ([a5d7524](https://github.com/0xtaos/chmonitor/commit/a5d75247ad342620bfb2b4834b3c009f1e60a771))
* **health:** surface the real error in failed mutation toasts ([#2687](https://github.com/0xtaos/chmonitor/issues/2687)) ([#2732](https://github.com/0xtaos/chmonitor/issues/2732)) ([e78043f](https://github.com/0xtaos/chmonitor/commit/e78043f270b9b72da021fba4bcb99a66c2f3a719))
* **insights:** redesign the AI Insights card, copy and popover dialog ([#2873](https://github.com/0xtaos/chmonitor/issues/2873)) ([14502f7](https://github.com/0xtaos/chmonitor/commit/14502f741f01fa417023367db5a11996926fb4e5))
* **insights:** restore severity accent left border on insight cards ([#2624](https://github.com/0xtaos/chmonitor/issues/2624)) ([ea3aabd](https://github.com/0xtaos/chmonitor/commit/ea3aabdc97abbe8a43e1b42f78310368689ebc68))
* **insights:** restore severity accent left border on insight cards ([#2626](https://github.com/0xtaos/chmonitor/issues/2626)) ([b2eb8e1](https://github.com/0xtaos/chmonitor/commit/b2eb8e1a072b6b7db50912333bd71beaecdac611))
* **insights:** scrollable, wider detail dialog for high-content findings ([#2798](https://github.com/0xtaos/chmonitor/issues/2798)) ([3ad48e7](https://github.com/0xtaos/chmonitor/commit/3ad48e747ec6dab600bb56c572398311489861e0))
* **landing:** align alert-channel copy with shipped adapters ([#3097](https://github.com/0xtaos/chmonitor/issues/3097)) ([267b60a](https://github.com/0xtaos/chmonitor/commit/267b60aec3d6c787a3d8e8cd72d32f8338ecb2af))
* **landing:** brand alt on nav logo SVG ([#3389](https://github.com/0xtaos/chmonitor/issues/3389)) ([7c4bff2](https://github.com/0xtaos/chmonitor/commit/7c4bff2a9d70bca0d45865c8bdd7f3e3a40f8443)), closes [#3387](https://github.com/0xtaos/chmonitor/issues/3387)
* **landing:** brand CLI install, beta badge, and What's new scroll ([#3203](https://github.com/0xtaos/chmonitor/issues/3203)) ([43ba12f](https://github.com/0xtaos/chmonitor/commit/43ba12f6868463d11974ee80fcf5de31b2384d4c))
* **landing:** crawlable JSON-LD and image alts ([#3383](https://github.com/0xtaos/chmonitor/issues/3383)) ([573504e](https://github.com/0xtaos/chmonitor/commit/573504e50cab93a0b15b4e843f2b745a71754aef))
* **landing:** deduplicate version badges in changelog band ([#2738](https://github.com/0xtaos/chmonitor/issues/2738)) ([32c154b](https://github.com/0xtaos/chmonitor/commit/32c154b321e16f586873e10de77c5d73ba19d701))
* **landing:** drop 01 / 08 section index labels ([#3157](https://github.com/0xtaos/chmonitor/issues/3157)) ([2e4592e](https://github.com/0xtaos/chmonitor/commit/2e4592edc6ec6da3857bcb641d5e91f987d68126))
* **landing:** footer theme toggle not working ([#2781](https://github.com/0xtaos/chmonitor/issues/2781)) ([51f12a9](https://github.com/0xtaos/chmonitor/commit/51f12a939e5b4b65ff2795d1bae594853a1d85f8))
* **landing:** frameless with-bg feature heroes, borderless gallery, section heading spacing ([#2754](https://github.com/0xtaos/chmonitor/issues/2754)) ([62d843d](https://github.com/0xtaos/chmonitor/commit/62d843d9db305c1f1bff569ce0eb1752f6b177ed))
* **landing:** hero flash, nav polish, more recent releases ([#2741](https://github.com/0xtaos/chmonitor/issues/2741)) ([c87f6bf](https://github.com/0xtaos/chmonitor/commit/c87f6bfee8146f0bea0071fb52a2730c551ba9a1))
* **landing:** hero latest post is Release or Update only ([#3265](https://github.com/0xtaos/chmonitor/issues/3265)) ([b5c0c79](https://github.com/0xtaos/chmonitor/commit/b5c0c79937af0ceaa3682732aefc2ac43f397ad7))
* **landing:** hide Pricing and Always shipping on homepage ([#3138](https://github.com/0xtaos/chmonitor/issues/3138)) ([56049bb](https://github.com/0xtaos/chmonitor/commit/56049bb80456d03872b85ac735be118bb9f09761))
* **landing:** loop the hero intro video ([#3156](https://github.com/0xtaos/chmonitor/issues/3156)) ([653df22](https://github.com/0xtaos/chmonitor/commit/653df22b085fdc2be3443c5c8f7798b5ce29ef16))
* **landing:** match boss email width to the license cards ([#3049](https://github.com/0xtaos/chmonitor/issues/3049)) ([a0ec57e](https://github.com/0xtaos/chmonitor/commit/a0ec57ef73d68febaa6fe127181b9f177f4bed4f))
* **landing:** move Cloud AI caps off the self-host FAQ ([#3098](https://github.com/0xtaos/chmonitor/issues/3098)) ([0657b6a](https://github.com/0xtaos/chmonitor/commit/0657b6a7dbc51a7e7d9bf1b7e23f801a13f4476f)), closes [#3090](https://github.com/0xtaos/chmonitor/issues/3090)
* **landing:** rebuild hero when the latest blog post changes ([#3168](https://github.com/0xtaos/chmonitor/issues/3168)) ([f3cabb0](https://github.com/0xtaos/chmonitor/commit/f3cabb0f2cb909ca5a1818fe8806be88c9810f3e))
* **landing:** restyle hero latest-post pill as title plus arrow ([#3155](https://github.com/0xtaos/chmonitor/issues/3155)) ([91117e0](https://github.com/0xtaos/chmonitor/commit/91117e01f3f96dcaad6da88840e970bae8a21e0c))
* **landing:** say four env-gated Postgres agent tools ([#3100](https://github.com/0xtaos/chmonitor/issues/3100)) ([2b0fcae](https://github.com/0xtaos/chmonitor/commit/2b0fcaedc9c1a6520e72ebfbed01b2ae8babe23e)), closes [#3093](https://github.com/0xtaos/chmonitor/issues/3093)
* **landing:** serve install.sh so curl -sSf works ([#3192](https://github.com/0xtaos/chmonitor/issues/3192)) ([87b390c](https://github.com/0xtaos/chmonitor/commit/87b390c72f821ffc98676c021fe06574ba6e693c))
* **landing:** show full self-host claim on 320px hero pill ([#3109](https://github.com/0xtaos/chmonitor/issues/3109)) ([e4d7533](https://github.com/0xtaos/chmonitor/commit/e4d753375e24206cfde886af67b3da8f01beff7f))
* **landing:** stop shipping an empty changelog page ([#3287](https://github.com/0xtaos/chmonitor/issues/3287)) ([3cffdc3](https://github.com/0xtaos/chmonitor/commit/3cffdc32917d3b74ffddd494ab8969c223cd1e12))
* **landing:** unclip mobile nav and comparison tables ([#3104](https://github.com/0xtaos/chmonitor/issues/3104)) ([e22f007](https://github.com/0xtaos/chmonitor/commit/e22f007385c8859fdc2979acefff19da3509de66))
* **lint:** resolve biome errors on main ([#2917](https://github.com/0xtaos/chmonitor/issues/2917)) ([c0874f7](https://github.com/0xtaos/chmonitor/commit/c0874f7d2b5c42e4b9a27b8f89cc0904fb1320a6))
* **lint:** resolve biome errors reintroduced by refactor merges ([#2931](https://github.com/0xtaos/chmonitor/issues/2931)) ([fb1e246](https://github.com/0xtaos/chmonitor/commit/fb1e246351f7efb4ef12e32d82d1fc743055c58e))
* **mcp-server:** add read-only tool annotations to all tools ([#2703](https://github.com/0xtaos/chmonitor/issues/2703)) ([#2724](https://github.com/0xtaos/chmonitor/issues/2724)) ([53b47c8](https://github.com/0xtaos/chmonitor/commit/53b47c85a28229fd8603772870da862295520201))
* **mcp-server:** cap get_running_queries rows with a limit param ([#2705](https://github.com/0xtaos/chmonitor/issues/2705)) ([#2722](https://github.com/0xtaos/chmonitor/issues/2722)) ([cf138d5](https://github.com/0xtaos/chmonitor/commit/cf138d563e6fccb1a477150130caf5e11187f54f))
* **mcp:** rate-limit /api/mcp with the existing agent limiter ([#2704](https://github.com/0xtaos/chmonitor/issues/2704)) ([#2726](https://github.com/0xtaos/chmonitor/issues/2726)) ([fcf20d5](https://github.com/0xtaos/chmonitor/commit/fcf20d5670ae061e54e6435981ffada7d6c95016))
* **mcp:** resource templates honour multi-host hostId ([#2707](https://github.com/0xtaos/chmonitor/issues/2707)) ([#2725](https://github.com/0xtaos/chmonitor/issues/2725)) ([8437b6e](https://github.com/0xtaos/chmonitor/commit/8437b6ea97c49f0726d67a3246430cda21e95609))
* **mcp:** serve /api/v1/mcp/info publicly ([#3211](https://github.com/0xtaos/chmonitor/issues/3211)) ([85ad406](https://github.com/0xtaos/chmonitor/commit/85ad40688621e89d4aa8a00073059cddc5b7d29f))
* **menu:** list Data Explorer under both Tools and Tables ([#3175](https://github.com/0xtaos/chmonitor/issues/3175)) ([d6f0e62](https://github.com/0xtaos/chmonitor/commit/d6f0e62cc3f36487912563fee68e6e37817ff3c1))
* **merges:** stop duplicate table column breaking the merges page ([#3029](https://github.com/0xtaos/chmonitor/issues/3029)) ([7bde351](https://github.com/0xtaos/chmonitor/commit/7bde351c81402dafa4260f0411ab6953a0cad1e1))
* **nav:** align favorite rows with the main menu ([#3028](https://github.com/0xtaos/chmonitor/issues/3028)) ([4f53b13](https://github.com/0xtaos/chmonitor/commit/4f53b1322d03e0ca28c25911f40c60f4d7d88a23))
* **nav:** hover-only pin and grip to reorder favorites ([#3027](https://github.com/0xtaos/chmonitor/issues/3027)) ([4b5791e](https://github.com/0xtaos/chmonitor/commit/4b5791e32ad9ad4b2e0345d97127acbdc13be7c5))
* only bump helm chart version when chart code changes, use latest image tag ([fa2a196](https://github.com/0xtaos/chmonitor/commit/fa2a196445aa38753c13fa1c85afa09dcd0f0daa))
* **pricing:** disclose beta-wide feature unlock on the landing pricing page ([#2744](https://github.com/0xtaos/chmonitor/issues/2744)) ([5bc6aec](https://github.com/0xtaos/chmonitor/commit/5bc6aecec103fcb8c485bf0bd71bc5e3b0c43825)), closes [#2678](https://github.com/0xtaos/chmonitor/issues/2678)
* **quota:** derive guest IP key from trusted headers only ([#3233](https://github.com/0xtaos/chmonitor/issues/3233)) ([c375742](https://github.com/0xtaos/chmonitor/commit/c3757424a28e207010f234161527db95db45f39b))
* **review:** post-merge review fixes — PDF plan gate, error handling, keys, radius ([#2821](https://github.com/0xtaos/chmonitor/issues/2821)) ([b213579](https://github.com/0xtaos/chmonitor/commit/b213579e67f9d0ebbf38a9f23df0abf88883f808))
* **schema-diff:** group tables in a tree and compact host pickers ([#3171](https://github.com/0xtaos/chmonitor/issues/3171)) ([06ae40f](https://github.com/0xtaos/chmonitor/commit/06ae40f703e2b9da55eb1993eda67fff3846f8e9))
* **schema-diff:** list matching tables with green checks ([#3169](https://github.com/0xtaos/chmonitor/issues/3169)) ([48de244](https://github.com/0xtaos/chmonitor/commit/48de2447aa1b90ca1cea2b438faa4df5a49a2eef))
* **schema-diff:** move diffs filter and sort onto the table sidebar ([#3173](https://github.com/0xtaos/chmonitor/issues/3173)) ([6fa9c65](https://github.com/0xtaos/chmonitor/commit/6fa9c6547bac687225e66d52ab5b506e5e17ec19))
* **schema-diff:** pretty-print DDL with UUID, ON CLUSTER, quoted names ([#3268](https://github.com/0xtaos/chmonitor/issues/3268)) ([783e312](https://github.com/0xtaos/chmonitor/commit/783e312626693d5a4814fdeb8b4136d453f3fe0d))
* **schema-diff:** share named deltas and split the page ([#3084](https://github.com/0xtaos/chmonitor/issues/3084)) ([7e13c3f](https://github.com/0xtaos/chmonitor/commit/7e13c3fccbc631c1886d5d01badbd47f89c9c524))
* **schema-diff:** show peer names and fix compare toolbar ([#3163](https://github.com/0xtaos/chmonitor/issues/3163)) ([1af0916](https://github.com/0xtaos/chmonitor/commit/1af09165ab4724cabc2b69acf78a1554a3250be8))
* **schema:** refresh ClickHouse version matrix through 26.7 LTS/stable ([3d4f90e](https://github.com/0xtaos/chmonitor/commit/3d4f90e532d1447b2666dba92fada955e25e2db9)), closes [#2857](https://github.com/0xtaos/chmonitor/issues/2857)
* **seo:** 301 apex dashboard URLs and drop slash/preview duplicates ([#3259](https://github.com/0xtaos/chmonitor/issues/3259)) ([15cc2e4](https://github.com/0xtaos/chmonitor/commit/15cc2e4f74f35fbd3537ccadbf8d8fdce7d1d2df))
* **seo:** one-hop redirects for old docs and feature URLs ([#3264](https://github.com/0xtaos/chmonitor/issues/3264)) ([4fb7706](https://github.com/0xtaos/chmonitor/commit/4fb770644dc1f05ff1855edafd68dffb9198c415))
* **seo:** stop watch-page slash redirect loop ([#3263](https://github.com/0xtaos/chmonitor/issues/3263)) ([67d21ac](https://github.com/0xtaos/chmonitor/commit/67d21ac10137eb9e03dd0e6bb3deb00b685588b4))
* **seo:** watch URLs without a version dot ([#3262](https://github.com/0xtaos/chmonitor/issues/3262)) ([df53a17](https://github.com/0xtaos/chmonitor/commit/df53a17f0c8051fcf369233c76e762b5a761dc5c))
* **settings-diff:** embed listing in the shared table chrome ([#3269](https://github.com/0xtaos/chmonitor/issues/3269)) ([ff8626b](https://github.com/0xtaos/chmonitor/commit/ff8626bcaec59533e94d989f2d509ae5006cbe9c))
* **settings-diff:** list matching settings with green checks ([#3170](https://github.com/0xtaos/chmonitor/issues/3170)) ([ba07ce7](https://github.com/0xtaos/chmonitor/commit/ba07ce70bd878ca4771da075f88783dbce0bdfed))
* **settings-diff:** show All matched when nothing differs ([#3164](https://github.com/0xtaos/chmonitor/issues/3164)) ([e87e9ca](https://github.com/0xtaos/chmonitor/commit/e87e9ca7ac501c34caa94e8a5a58cdaeb0901047))
* **settings:** flatten dialog nav into a sectioned rail ([#3021](https://github.com/0xtaos/chmonitor/issues/3021)) ([8b6fb31](https://github.com/0xtaos/chmonitor/commit/8b6fb3111e2f40aba20f196a7031cf5f7c9d79c8))
* **settings:** keep theme on Appearance only ([#3024](https://github.com/0xtaos/chmonitor/issues/3024)) ([1ea92ae](https://github.com/0xtaos/chmonitor/commit/1ea92ae01ee3079737b125b0ab40fc0501b54dee))
* **settings:** pick Dim or Hide with menu demos ([#3025](https://github.com/0xtaos/chmonitor/issues/3025)) ([2204c8f](https://github.com/0xtaos/chmonitor/commit/2204c8f7c7aeeb88668029aa86bf60fa996a9303))
* **settings:** put light and dark theme on General ([#3020](https://github.com/0xtaos/chmonitor/issues/3020)) ([106bd73](https://github.com/0xtaos/chmonitor/commit/106bd7319070ad3884c5bb6836af95adb0f46904))
* **settings:** put theme on a compact window-preview row ([#3022](https://github.com/0xtaos/chmonitor/issues/3022)) ([895bc48](https://github.com/0xtaos/chmonitor/commit/895bc48e6565177b827f9e06a6f7f46fd9245208))
* **settings:** stabilize dialog and polish timezone, palette, units ([#3019](https://github.com/0xtaos/chmonitor/issues/3019)) ([7aca4db](https://github.com/0xtaos/chmonitor/commit/7aca4db285770986dc1eeaef6f90a3d5db43973c))
* **sidebar:** hide count/new badge when the pin action is visible ([#2875](https://github.com/0xtaos/chmonitor/issues/2875)) ([f0c29c8](https://github.com/0xtaos/chmonitor/commit/f0c29c8fe730f6e0be950ea5aa91d846efd639fc))
* **sidebar:** stop pin and drag icons overlapping in Favorites ([#3034](https://github.com/0xtaos/chmonitor/issues/3034)) ([39900f6](https://github.com/0xtaos/chmonitor/commit/39900f67fceab7dc2d3d35fb3bb0aa0ae169f00d))
* **sql-builder:** reject INTO OUTFILE/INTO FILE in sql-validator ([#3229](https://github.com/0xtaos/chmonitor/issues/3229)) ([4ef0bc4](https://github.com/0xtaos/chmonitor/commit/4ef0bc4c0a15927ee45d38ca1d1e044621b64501)), closes [#3222](https://github.com/0xtaos/chmonitor/issues/3222)
* **sql-builder:** render SqlFragment columns via toSql in ExtendedBuilder ([#2967](https://github.com/0xtaos/chmonitor/issues/2967)) ([ba0f29b](https://github.com/0xtaos/chmonitor/commit/ba0f29bbc0c316aba85771121188566fdfe8c79c)), closes [#2966](https://github.com/0xtaos/chmonitor/issues/2966)
* **sql-builder:** stop scanning string literals in validator; fix '/*/' comment parsing ([#2958](https://github.com/0xtaos/chmonitor/issues/2958)) ([fcaeb81](https://github.com/0xtaos/chmonitor/commit/fcaeb81630b3ae925ac969ec8c5fa3ee756c1fc1)), closes [#2949](https://github.com/0xtaos/chmonitor/issues/2949) [#2950](https://github.com/0xtaos/chmonitor/issues/2950)
* **telemetry:** bind preview Worker to production D1 ([#3246](https://github.com/0xtaos/chmonitor/issues/3246)) ([24481ec](https://github.com/0xtaos/chmonitor/commit/24481eca74e7539556cbf6266507b37c6051f29d))
* **telemetry:** fill ping dimensions instead of locking empty rows ([#3252](https://github.com/0xtaos/chmonitor/issues/3252)) ([4436c2d](https://github.com/0xtaos/chmonitor/commit/4436c2d5c72381ccd90593ca2622f17b4bdae0ba))
* **telemetry:** hide empty and unknown ClickHouse flavors ([#3249](https://github.com/0xtaos/chmonitor/issues/3249)) ([c9dba4b](https://github.com/0xtaos/chmonitor/commit/c9dba4b3bd1abd3986335b8742797d1b9ebf287d))
* **telemetry:** logos for unknown, linux, ios, android ([#3247](https://github.com/0xtaos/chmonitor/issues/3247)) ([2307f9c](https://github.com/0xtaos/chmonitor/commit/2307f9c27793fedd5f2be3d3c03c707f09c103e0))
* **telemetry:** merge empty and unknown chmonitor versions ([#3251](https://github.com/0xtaos/chmonitor/issues/3251)) ([481c4d4](https://github.com/0xtaos/chmonitor/commit/481c4d4639b029f12ad88927a94b3819563d8411))
* **telemetry:** merge empty and unknown ClickHouse versions ([#3250](https://github.com/0xtaos/chmonitor/issues/3250)) ([11201d4](https://github.com/0xtaos/chmonitor/commit/11201d4a89ac65fd0cd79f52a6f6bf3b9b89fe61))
* **traffic:** responsive KPI strip — 4 columns only at lg, truncate values ([#2751](https://github.com/0xtaos/chmonitor/issues/2751)) ([20a594b](https://github.com/0xtaos/chmonitor/commit/20a594b5dfc6ff3890f674248f54c942a2f67ec4))
* **traffic:** review findings — host routing and undefined chart tokens ([#2650](https://github.com/0xtaos/chmonitor/issues/2650)) ([d81cb53](https://github.com/0xtaos/chmonitor/commit/d81cb5398dbd1174125b39ee7b81ab84864b7517))
* **ui:** keep command palette titles on one line ([#3278](https://github.com/0xtaos/chmonitor/issues/3278)) ([6e608cd](https://github.com/0xtaos/chmonitor/commit/6e608cd782518baacd83aade36cdbf65dedadb61))
* **ui:** pin icon sizing, host switcher spacing, settings redesign ([#2797](https://github.com/0xtaos/chmonitor/issues/2797)) ([d428fb6](https://github.com/0xtaos/chmonitor/commit/d428fb6339d82b4e64934b97d6466e06ada65581))
* **ui:** reveal agent and notification actions on keyboard focus ([#3010](https://github.com/0xtaos/chmonitor/issues/3010)) ([7239d64](https://github.com/0xtaos/chmonitor/commit/7239d647c6c423822082b8f83a35b9ec2ec259d9))
* **ui:** reveal console and MCP copy actions on keyboard focus ([#3008](https://github.com/0xtaos/chmonitor/issues/3008)) ([14e7daa](https://github.com/0xtaos/chmonitor/commit/14e7daad5acff98f696960ce96e27242a96ffc4c))
* **ui:** reveal leftover query-page hover controls on keyboard focus ([#3011](https://github.com/0xtaos/chmonitor/issues/3011)) ([bb69bdd](https://github.com/0xtaos/chmonitor/commit/bb69bddcdccf265e0d56aab0713f51181e525642))
* **ui:** reveal query-row actions on keyboard focus ([#3012](https://github.com/0xtaos/chmonitor/issues/3012)) ([2c4018d](https://github.com/0xtaos/chmonitor/commit/2c4018df862044232b0706f545113a16a40143dd))
* **ui:** show data-table header controls on keyboard focus ([#3013](https://github.com/0xtaos/chmonitor/issues/3013)) ([adb3fb7](https://github.com/0xtaos/chmonitor/commit/adb3fb7cae7810fe50c06070e383d764b2432bc1))
* **ui:** small health and insights keyboard/empty polish ([#3015](https://github.com/0xtaos/chmonitor/issues/3015)) ([4b8b55d](https://github.com/0xtaos/chmonitor/commit/4b8b55d6ece3b1048b9af67e596c2b5aae9a79c1))
* **ui:** small host and connection empty-state polish ([#3016](https://github.com/0xtaos/chmonitor/issues/3016)) ([1c6247e](https://github.com/0xtaos/chmonitor/commit/1c6247e6979972d8d7952dad5953ef8f30d5d660))
* **ui:** small settings and sidebar keyboard polish ([#3009](https://github.com/0xtaos/chmonitor/issues/3009)) ([b53e6aa](https://github.com/0xtaos/chmonitor/commit/b53e6aa56001a76bfe4d03ae795d129040e45cd9))
* **ux:** confirmations for destructive Health/SQL-console actions ([#2682](https://github.com/0xtaos/chmonitor/issues/2682)) ([#2719](https://github.com/0xtaos/chmonitor/issues/2719)) ([66a4994](https://github.com/0xtaos/chmonitor/commit/66a4994923ab4af1e08d6e192a3850738d1f20f8))
* **workspace:** exclude test files from query-advisor-core type-check ([#2973](https://github.com/0xtaos/chmonitor/issues/2973)) ([f20bd79](https://github.com/0xtaos/chmonitor/commit/f20bd79a9895534c10b60827451fa72a3a15acac))


### ⚡ Performance

* **agent:** load the floating agent's chunk on first open, not on page load ([#2996](https://github.com/0xtaos/chmonitor/issues/2996)) ([41d4763](https://github.com/0xtaos/chmonitor/commit/41d476379f791aa9eda68d3bfc87c364b6357667)), closes [#2995](https://github.com/0xtaos/chmonitor/issues/2995)
* **charts:** lazy-load the zoom dialog so charts stop shipping the data-table ([#3001](https://github.com/0xtaos/chmonitor/issues/3001)) ([d736ff1](https://github.com/0xtaos/chmonitor/commit/d736ff19f83fde779fdedd224c0ebf5303b9ebff)), closes [#3000](https://github.com/0xtaos/chmonitor/issues/3000)
* **charts:** stop shipping unread columns in new-parts-created ([#2991](https://github.com/0xtaos/chmonitor/issues/2991)) ([bc10ad3](https://github.com/0xtaos/chmonitor/commit/bc10ad3b36e4fc3eefe4d9c75197d796708d2427)), closes [#2986](https://github.com/0xtaos/chmonitor/issues/2986)
* **dashboard:** dedupe user-settings fetch through TanStack Query ([#2988](https://github.com/0xtaos/chmonitor/issues/2988)) ([a616404](https://github.com/0xtaos/chmonitor/commit/a616404ef2c8f337c83f6f94747b9ff5e419454e))
* **dashboard:** match chart refresh intervals to data volatility ([#3096](https://github.com/0xtaos/chmonitor/issues/3096)) ([53b299f](https://github.com/0xtaos/chmonitor/commit/53b299fa57adb1db92179a350566e1a629464835)), closes [#2992](https://github.com/0xtaos/chmonitor/issues/2992)
* **dashboard:** pause the last three polling sites on hidden tabs ([#3004](https://github.com/0xtaos/chmonitor/issues/3004)) ([8cd382b](https://github.com/0xtaos/chmonitor/commit/8cd382b4ffaf4ac6dcf818a42de0914eb94826ba)), closes [#3003](https://github.com/0xtaos/chmonitor/issues/3003)
* **dashboard:** Worker bundle size headroom under free 3 MiB ([#2855](https://github.com/0xtaos/chmonitor/issues/2855)) ([b4a5836](https://github.com/0xtaos/chmonitor/commit/b4a58365c30e327cc79dd228948d6336677584bf))
* **data-table:** defer react-markdown out of the eager formatter registry ([#2998](https://github.com/0xtaos/chmonitor/issues/2998)) ([f1aa749](https://github.com/0xtaos/chmonitor/commit/f1aa749541caecf4a384fca7298f144b3cc3fa1f)), closes [#2997](https://github.com/0xtaos/chmonitor/issues/2997)
* **insights:** generate once per host instead of once per mounted consumer ([#2989](https://github.com/0xtaos/chmonitor/issues/2989)) ([8e4272a](https://github.com/0xtaos/chmonitor/commit/8e4272afb31ea39f654c4437e6d0ad28ab034d90)), closes [#2985](https://github.com/0xtaos/chmonitor/issues/2985)
* **test:** StatTile, lazy markdown, query-insights batch, sweep parity, diff tests ([#3341](https://github.com/0xtaos/chmonitor/issues/3341)) ([b0037ab](https://github.com/0xtaos/chmonitor/commit/b0037ab496a76c53ff8f5aa169b9633c19c97dc1))
